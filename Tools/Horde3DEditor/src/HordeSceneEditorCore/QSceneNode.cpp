...
{
	x = m_xmlNode.attribute("tx", "0.0").remove('f').toFloat();
	y = m_xmlNode.attribute("ty", "0.0").remove('f').toFloat();
	z = m_xmlNode.attribute("tz", "0.0").remove('f').toFloat();
	rx = m_xmlNode.attribute("rx", "0.0").remove('f').toFloat();
	ry = m_xmlNode.attribute("ry", "0.0").remove('f').toFloat();
	rz = m_xmlNode.attribute("rz", "0.0").remove('f').toFloat();
	sx = m_xmlNode.attribute("sx", "1.0").remove('f').toFloat();
	sy = m_xmlNode.attribute("sy", "1.0").remove('f').toFloat();
	sz = m_xmlNode.attribute("sz", "1.0").remove('f').toFloat();
}
...
QVec3f QSceneNode::position() const
{
	...
	return QVec3f(
		m_xmlNode.attribute("tx", "0.0").remove('f').toFloat(), 
		m_xmlNode.attribute("ty", "0.0").remove('f').toFloat(), 
		m_xmlNode.attribute("tz", "0.0").remove('f').toFloat());
}
...
{
	return QVec3f(
		m_xmlNode.attribute("rx", "0.0").remove('f').toFloat(), 
		m_xmlNode.attribute("ry", "0.0").remove('f').toFloat(), 
		m_xmlNode.attribute("rz", "0.0").remove('f').toFloat());
}
...
{
	return QVec3f(
		m_xmlNode.attribute("sx", "1.0").remove('f').toFloat(), 
		m_xmlNode.attribute("sy", "1.0").remove('f').toFloat(), 
		m_xmlNode.attribute("sz", "1.0").remove('f').toFloat());
}
