...
FrustumProperty::FrustumProperty(const QString& name /*= QString()*/, QObject* propertyObject /*= 0*/, QObject* parent /*= 0*/) : Property(name, propertyObject, parent)
{
	...
	m_left->setEditorHints("minimum=-2147483647;maximum=2147483647;decimals=6;singleStep=0.001;");
	m_right = new Property("Right", this, this);
	m_right->setEditorHints("minimum=-2147483647;maximum=2147483647;decimals=6;singleStep=0.001;");
	m_bottom = new Property("Bottom", this, this);
	m_bottom->setEditorHints("minimum=-2147483647;maximum=2147483647;decimals=6;singleStep=0.001;");
	m_top = new Property("Top", this, this);
	m_top->setEditorHints("minimum=-2147483647;maximum=2147483647;decimals=6;singleStep=0.001;");
	m_near = new Property("Near", this, this);
	m_near->setEditorHints("minimum=0.0001;maximum=2147483647;decimals=4;singleStep=0.001;");
	m_far = new Property("Far", this, this);
	m_far->setEditorHints("minimum=0.001;maximum=2147483647;decimals=3;singleStep=0.001;");
