...
void main( void )
{
	...
	// Wassertextur weiterschieben
	texCoords.y -= counter.a * 0.005;
	
	// Wasserbewegung
	pos.y = pos.y - (sin((pos.x * 15 + counter.a * 0.4)) + cos((pos.z * 15 + counter.a * 0.4))) * 0.007;
...
void main( void )
{
	...
	// Normalen rotieren als Wasserbewegungsfake
	normalMap.x *= sin(counter.a * 0.15);
	normalMap.y *= cos(counter.a * 0.15);
