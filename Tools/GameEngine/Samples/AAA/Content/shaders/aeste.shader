...
void main( void )
{
	...
	// Bewegung im Wind
	pos.y = pos.y - sin(pos.y + counter.a * 0.1) * 0.02;
	pos.x = pos.x - cos(pos.x + counter.a * 0.2) * 0.02;
	pos.z = pos.z - sin(pos.z + counter.a * 0.1) * 0.02;
...
void main( void )
{
	...
	gl_FragColor.rgb = ((albedo.rgb * 0.3) + (tempColor * 0.9));
}
