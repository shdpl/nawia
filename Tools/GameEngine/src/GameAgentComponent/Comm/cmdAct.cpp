...
{	
	...
	m_attributes.push_back( new CommandAttribute("shakeaxis",	AttributeType::INTEGER,		&m_shakeAxis, 0, 0) );

	//synonym to shake
	m_attributes.push_back( new CommandAttribute("nod",			AttributeType::INTEGER,		&m_shakeReps, 0, &m_doShake) );
	m_attributes.push_back( new CommandAttribute("nodext",		AttributeType::FLOAT,		&m_shakeExtent, 0, 0) );
	m_attributes.push_back( new CommandAttribute("nodspd",		AttributeType::FLOAT,		&m_shakeSpeed, 0, 0) );
	m_attributes.push_back( new CommandAttribute("noddur",		AttributeType::FLOAT,		&m_shakeDuration, 0, 0) );
	m_attributes.push_back( new CommandAttribute("nodaxis",		AttributeType::INTEGER,		&m_shakeAxis, 0, 0) );
...
void cmdAct::execute()
{
	...
	if(m_doShake)
	{
		GameEngine::Agent_headShake( agent_eID, m_shakeAxis, m_shakeExtent, m_shakeReps, m_shakeSpeed, m_shakeDuration );
	}
