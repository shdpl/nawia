...
void Orientation_N::execute_alphaAction(unsigned int myEntityID, unsigned int otherEntityID)
{
...
void Orientation_N::execute_betaAction(unsigned int myEntityID, unsigned int otherEntityID)
{
	/*turnTowards(myEntityID, otherEntityID);
