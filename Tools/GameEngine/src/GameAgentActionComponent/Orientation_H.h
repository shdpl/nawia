...
// 
// ****************************************************************************************
#ifndef ORIENTATION_H_H_
#define ORIENTATION_H_H_

#include "Orientation.h"

class Orientation_H : public Orientation
{
public:
	Orientation_H(AgentActionComponent* component) : Orientation(component)
	{
		m_type = Orientation::H;
	};
