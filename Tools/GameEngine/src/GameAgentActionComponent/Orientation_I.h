...
// 
// ****************************************************************************************
#ifndef ORIENTATION_I_H_
#define ORIENTATION_I_H_

#include "Orientation.h"

class Orientation_I : public Orientation
{
public:
	Orientation_I(AgentActionComponent* component) : Orientation(component)
	{
		m_type = Orientation::I;
	};
