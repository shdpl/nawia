...
// 
// ****************************************************************************************
#ifndef ORIENTATION_V_H_
#define ORIENTATION_V_H_

#include "Orientation.h"

class Orientation_V : public Orientation
{
public:
	Orientation_V(AgentActionComponent* component) : Orientation(component)
	{
		m_type = Orientation::V;
	};
