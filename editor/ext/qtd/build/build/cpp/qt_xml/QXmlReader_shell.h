#ifndef QXMLREADER_SHELL_H
#define QXMLREADER_SHELL_H
...
class QXmlReader_QtDShell : public QXmlReader, public QtdObjectLink
{
public:
    QXmlReader_QtDShell(void *d_ptr);
    ~QXmlReader_QtDShell();
