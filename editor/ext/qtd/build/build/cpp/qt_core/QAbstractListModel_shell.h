#ifndef QABSTRACTLISTMODEL_SHELL_H
#define QABSTRACTLISTMODEL_SHELL_H
...
class QAbstractListModel_QtDShell : public QAbstractListModel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractListModel_QtDShell(void *d_ptr, QObject*  parent0);
    ~QAbstractListModel_QtDShell();
...
#endif // QABSTRACTLISTMODEL_SHELL_H
