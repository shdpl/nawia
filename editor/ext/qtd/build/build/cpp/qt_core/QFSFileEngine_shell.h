#ifndef QFSFILEENGINE_SHELL_H
#define QFSFILEENGINE_SHELL_H
...
class QFSFileEngine_QtDShell : public QFSFileEngine, public QtdObjectLink
{
public:
    QFSFileEngine_QtDShell(void *d_ptr);
    QFSFileEngine_QtDShell(void *d_ptr, const QString&  file0);
    ~QFSFileEngine_QtDShell();
    ...
    bool  open(QIODevice::OpenMode  flags0, int  fd1);
    ...
    bool  __override_seek(qint64  arg__1, bool static_call);
