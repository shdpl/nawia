#ifndef QTEMPORARYFILE_SHELL_H
#define QTEMPORARYFILE_SHELL_H
...
class QTemporaryFile_QtDShell : public QTemporaryFile, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTemporaryFile_QtDShell(void *d_ptr);
    QTemporaryFile_QtDShell(void *d_ptr, QObject*  parent0);
    QTemporaryFile_QtDShell(void *d_ptr, const QString&  templateName0);
    QTemporaryFile_QtDShell(void *d_ptr, const QString&  templateName0, QObject*  parent1);
    ~QTemporaryFile_QtDShell();
