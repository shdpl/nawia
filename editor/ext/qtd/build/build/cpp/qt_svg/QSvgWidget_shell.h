#ifndef QSVGWIDGET_SHELL_H
#define QSVGWIDGET_SHELL_H
...
class QSvgWidget_QtDShell : public QSvgWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QSvgWidget_QtDShell(void *d_ptr, QWidget*  parent0);
    QSvgWidget_QtDShell(void *d_ptr, const QString&  file0, QWidget*  parent1);
    ~QSvgWidget_QtDShell();
