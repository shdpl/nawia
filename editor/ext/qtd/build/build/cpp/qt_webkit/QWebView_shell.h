#ifndef QWEBVIEW_SHELL_H
#define QWEBVIEW_SHELL_H
...
class QWebView_QtDShell : public QWebView, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QWebView_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QWebView_QtDShell();
    ...
    QWebView*  createWindow(QWebPage::WebWindowType  type0);
    ...
    void __public_iconChanged();
    void __public_linkClicked(const QUrl&  arg__1);
    void __public_loadFinished(bool  arg__1);
    ...
    void __public_titleChanged(const QString&  title0);
    void __public_urlChanged(const QUrl&  arg__1);
    ...
    QWebView*  __override_createWindow(int  type0, bool static_call);
