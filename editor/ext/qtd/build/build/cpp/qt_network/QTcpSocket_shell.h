#ifndef QTCPSOCKET_SHELL_H
#define QTCPSOCKET_SHELL_H
...
class QTcpSocket_QtDShell : public QTcpSocket, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTcpSocket_QtDShell(void *d_ptr, QObject*  parent0);
    ~QTcpSocket_QtDShell();
