#ifndef QABSTRACTSOCKET_SHELL_H
#define QABSTRACTSOCKET_SHELL_H
...
class QAbstractSocket_QtDShell : public QAbstractSocket, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractSocket_QtDShell(void *d_ptr, QAbstractSocket::SocketType  socketType0, QObject*  parent1);
    ~QAbstractSocket_QtDShell();
    ...
    void connectToHostImplementation(const QString&  hostName0, unsigned short  port1, QIODevice::OpenMode  mode2);
    void __public_connectToHostImplementation(const QString&  hostName0, unsigned short  port1, int  mode2);
