#ifndef QABSTRACTNETWORKCACHE_SHELL_H
#define QABSTRACTNETWORKCACHE_SHELL_H
...
class QAbstractNetworkCache_QtDShell : public QAbstractNetworkCache, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractNetworkCache_QtDShell(void *d_ptr, QObject*  parent0);
    ~QAbstractNetworkCache_QtDShell();
...
#endif // QABSTRACTNETWORKCACHE_SHELL_H
