#ifndef QFORMLAYOUT_SHELL_H
#define QFORMLAYOUT_SHELL_H
...
class QFormLayout_QtDShell : public QFormLayout, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QFormLayout_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QFormLayout_QtDShell();
    ...
    int  heightForWidth(int  width0) const;
    int  indexOf(QWidget*  arg__1) const;
    void invalidate();
    bool  isEmpty() const;
    QLayoutItem*  itemAt(int  index0) const;
    QLayout*  layout();
    ...
    QLayoutItem*  takeAt(int  index0);
    void timerEvent(QTimerEvent*  arg__1);
    QWidget*  widget();
    QLayoutItem*  itemAt(int  row0, QFormLayout::ItemRole  role1) const;
    ...
    int  __override_heightForWidth(int  width0, bool static_call) const;
    ...
    QLayoutItem*  __override_itemAt(int  index0, bool static_call) const;
    ...
    QLayoutItem*  __override_takeAt(int  index0, bool static_call);
    void __override_timerEvent(QTimerEvent*  arg__1, bool static_call);
    QWidget*  __override_widget(bool static_call);
};

#endif // QFORMLAYOUT_SHELL_H
