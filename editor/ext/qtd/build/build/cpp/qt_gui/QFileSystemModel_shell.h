#ifndef QFILESYSTEMMODEL_SHELL_H
#define QFILESYSTEMMODEL_SHELL_H
...
class QFileSystemModel_QtDShell : public QFileSystemModel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QFileSystemModel_QtDShell(void *d_ptr, QObject*  parent0);
    ~QFileSystemModel_QtDShell();
    ...
    QModelIndex  index(const QString&  path0, int  column1) const;
    ...
    void __public_directoryLoaded(const QString&  path0);
    void __public_fileRenamed(const QString&  path0, const QString&  oldName1, const QString&  newName2);
    ...
    void __public_rootPathChanged(const QString&  newPath0);
...
#endif // QFILESYSTEMMODEL_SHELL_H
