#ifndef QSTYLE_SHELL_H
#define QSTYLE_SHELL_H
...
class QStyle_QtDShell : public QStyle, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QStyle_QtDShell(void *d_ptr);
    ~QStyle_QtDShell();

    void childEvent(QChildEvent*  arg__1);
    void customEvent(QEvent*  arg__1);
    void drawComplexControl(QStyle::ComplexControl  cc0, const QStyleOptionComplex*  opt1, QPainter*  p2, const QWidget*  widget3) const;
    ...
    QStyle::SubControl  hitTestComplexControl(QStyle::ComplexControl  cc0, const QStyleOptionComplex*  opt1, const QPoint&  pt2, const QWidget*  widget3) const;
    ...
    QSize  sizeFromContents(QStyle::ContentsType  ct0, const QStyleOption*  opt1, const QSize&  contentsSize2, const QWidget*  w3) const;
    QPalette  standardPalette() const;
    int  styleHint(QStyle::StyleHint  stylehint0, const QStyleOption*  opt1, const QWidget*  widget2, QStyleHintReturn*  returnData3) const;
    ...
    QRect  subElementRect(QStyle::SubElement  subElement0, const QStyleOption*  option1, const QWidget*  widget2) const;
    ...
    void __override_drawComplexControl(int  cc0, const QStyleOptionComplex*  opt1, QPainter*  p2, const QWidget*  widget3, bool static_call) const;
    ...
    int  __override_hitTestComplexControl(int  cc0, const QStyleOptionComplex*  opt1, const QPoint&  pt2, const QWidget*  widget3, bool static_call) const;
    ...
    QSize  __override_sizeFromContents(int  ct0, const QStyleOption*  opt1, const QSize&  contentsSize2, const QWidget*  w3, bool static_call) const;
    QPalette  __override_standardPalette(bool static_call) const;
    int  __override_styleHint(int  stylehint0, const QStyleOption*  opt1, const QWidget*  widget2, QStyleHintReturn*  returnData3, bool static_call) const;
    ...
    QRect  __override_subElementRect(int  subElement0, const QStyleOption*  option1, const QWidget*  widget2, bool static_call) const;
