#ifndef QPLAINTEXTEDIT_SHELL_H
#define QPLAINTEXTEDIT_SHELL_H
...
class QPlainTextEdit_QtDShell : public QPlainTextEdit, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QPlainTextEdit_QtDShell(void *d_ptr, QWidget*  parent0);
    QPlainTextEdit_QtDShell(void *d_ptr, const QString&  text0, QWidget*  parent1);
    ~QPlainTextEdit_QtDShell();
    ...
    QRectF  __public_blockBoundingGeometry(const QTextBlock&  block0) const;
    QRectF  __public_blockBoundingRect(const QTextBlock&  block0) const;
    QPointF  __public_contentOffset() const;
    void __public_destroy(bool  destroyWindow0, bool  destroySubWindows1);
    void __public_drawFrame(QPainter*  arg__1);
    QTextBlock  __public_firstVisibleBlock() const;
    bool  __public_focusNextChild();
    bool  __public_focusPreviousChild();
    QAbstractTextDocumentLayout::PaintContext  __public_getPaintContext() const;
    ...
    void __public_modificationChanged(bool  arg__1);
    ...
    void __public_updateRequest(const QRect&  rect0, int  dy1);
