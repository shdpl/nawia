#ifndef QLAYOUTITEM_SHELL_H
#define QLAYOUTITEM_SHELL_H
...
class QLayoutItem_QtDShell : public QLayoutItem, public QtdObjectLink
{
public:
    QLayoutItem_QtDShell(void *d_ptr, Qt::Alignment  alignment0);
    ~QLayoutItem_QtDShell();
    ...
    Qt::Alignment  align__getter();
    void align__setter(Qt::Alignment  align0);
};

#endif // QLAYOUTITEM_SHELL_H
