#ifndef QACCESSIBLEWIDGET_SHELL_H
#define QACCESSIBLEWIDGET_SHELL_H
...
class QAccessibleWidget_QtDShell : public QAccessibleWidget, public QtdObjectLink
{
public:
    QAccessibleWidget_QtDShell(void *d_ptr, QWidget*  o0, QAccessible::Role  r1, const QString&  name2);
    ~QAccessibleWidget_QtDShell();
...
#endif // QACCESSIBLEWIDGET_SHELL_H
