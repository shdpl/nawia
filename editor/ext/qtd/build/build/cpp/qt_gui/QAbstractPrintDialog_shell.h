#ifndef QABSTRACTPRINTDIALOG_SHELL_H
#define QABSTRACTPRINTDIALOG_SHELL_H
...
class QAbstractPrintDialog_QtDShell : public QAbstractPrintDialog, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractPrintDialog_QtDShell(void *d_ptr, QPrinter*  printer0, QWidget*  parent1);
    ~QAbstractPrintDialog_QtDShell();
...
#endif // QABSTRACTPRINTDIALOG_SHELL_H
