#ifndef QABSTRACTSCROLLAREA_SHELL_H
#define QABSTRACTSCROLLAREA_SHELL_H
...
class QAbstractScrollArea_QtDShell : public QAbstractScrollArea, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractScrollArea_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QAbstractScrollArea_QtDShell();
...
#endif // QABSTRACTSCROLLAREA_SHELL_H
