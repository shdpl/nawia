#ifndef QTIMEEDIT_SHELL_H
#define QTIMEEDIT_SHELL_H
...
class QTimeEdit_QtDShell : public QTimeEdit, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTimeEdit_QtDShell(void *d_ptr, QWidget*  parent0);
    QTimeEdit_QtDShell(void *d_ptr, const QTime&  time0, QWidget*  parent1);
    ~QTimeEdit_QtDShell();
