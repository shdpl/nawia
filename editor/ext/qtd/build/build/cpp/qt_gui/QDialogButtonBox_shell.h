#ifndef QDIALOGBUTTONBOX_SHELL_H
#define QDIALOGBUTTONBOX_SHELL_H
...
class QDialogButtonBox_QtDShell : public QDialogButtonBox, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QDialogButtonBox_QtDShell(void *d_ptr, QDialogButtonBox::StandardButtons  buttons0, Qt::Orientation  orientation1, QWidget*  parent2);
    QDialogButtonBox_QtDShell(void *d_ptr, QWidget*  parent0);
    QDialogButtonBox_QtDShell(void *d_ptr, Qt::Orientation  orientation0, QWidget*  parent1);
    ~QDialogButtonBox_QtDShell();
    ...
    void __public_clicked(QAbstractButton*  button0);
...
#endif // QDIALOGBUTTONBOX_SHELL_H
