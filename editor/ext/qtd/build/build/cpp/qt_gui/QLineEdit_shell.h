#ifndef QLINEEDIT_SHELL_H
#define QLINEEDIT_SHELL_H
...
class QLineEdit_QtDShell : public QLineEdit, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QLineEdit_QtDShell(void *d_ptr, QWidget*  parent0);
    QLineEdit_QtDShell(void *d_ptr, const QString&  arg__1, QWidget*  parent1);
    ~QLineEdit_QtDShell();
    ...
    QRect  __public_cursorRect() const;
    ...
    void __public_initStyleOption(QStyleOptionFrame*  option0) const;
    void __public_resetInputContext();
    QObject*  __public_sender() const;
    void __public_updateMicroFocus();
    void __public_cursorPositionChanged(int  arg__1, int  arg__2);
    void __public_customContextMenuRequested(const QPoint&  pos0);
    void __public_editingFinished();
    void __public_returnPressed();
    void __public_selectionChanged();
    void __public_textChanged(const QString&  arg__1);
    void __public_textEdited(const QString&  arg__1);
