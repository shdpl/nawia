#ifndef QWIDGETITEM_SHELL_H
#define QWIDGETITEM_SHELL_H
...
class QWidgetItem_QtDShell : public QWidgetItem, public QtdObjectLink
{
public:
    QWidgetItem_QtDShell(void *d_ptr, QWidget*  w0);
    ~QWidgetItem_QtDShell();
