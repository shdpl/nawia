#ifndef QSPLASHSCREEN_SHELL_H
#define QSPLASHSCREEN_SHELL_H
...
class QSplashScreen_QtDShell : public QSplashScreen, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QSplashScreen_QtDShell(void *d_ptr, QWidget*  parent0, const QPixmap&  pixmap1, Qt::WindowFlags  f2);
    QSplashScreen_QtDShell(void *d_ptr, const QPixmap&  pixmap0, Qt::WindowFlags  f1);
    ~QSplashScreen_QtDShell();
    ...
    void drawContents(QPainter*  painter0);
    ...
    void __public_messageChanged(const QString&  message0);
    ...
    void __override_drawContents(QPainter*  painter0, bool static_call);
