#ifndef QGRAPHICSELLIPSEITEM_SHELL_H
#define QGRAPHICSELLIPSEITEM_SHELL_H
...
class QGraphicsEllipseItem_QtDShell : public QGraphicsEllipseItem, public QtdObjectLink
{
public:
    QGraphicsEllipseItem_QtDShell(void *d_ptr, QGraphicsItem*  parent0, QGraphicsScene*  scene1);
    QGraphicsEllipseItem_QtDShell(void *d_ptr, const QRectF&  rect0, QGraphicsItem*  parent1, QGraphicsScene*  scene2);
    QGraphicsEllipseItem_QtDShell(void *d_ptr, double  x0, double  y1, double  w2, double  h3, QGraphicsItem*  parent4, QGraphicsScene*  scene5);
    ~QGraphicsEllipseItem_QtDShell();
...
#endif // QGRAPHICSELLIPSEITEM_SHELL_H
