#ifndef QSTACKEDWIDGET_SHELL_H
#define QSTACKEDWIDGET_SHELL_H
...
class QStackedWidget_QtDShell : public QStackedWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QStackedWidget_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QStackedWidget_QtDShell();
    ...
    void __public_currentChanged(int  arg__1);
