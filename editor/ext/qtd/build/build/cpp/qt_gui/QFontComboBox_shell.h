#ifndef QFONTCOMBOBOX_SHELL_H
#define QFONTCOMBOBOX_SHELL_H
...
class QFontComboBox_QtDShell : public QFontComboBox, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QFontComboBox_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QFontComboBox_QtDShell();
    ...
    void __public_currentFontChanged(const QFont&  f0);
