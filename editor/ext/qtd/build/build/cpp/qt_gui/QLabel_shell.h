#ifndef QLABEL_SHELL_H
#define QLABEL_SHELL_H
...
class QLabel_QtDShell : public QLabel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QLabel_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  f1);
    QLabel_QtDShell(void *d_ptr, const QString&  text0, QWidget*  parent1, Qt::WindowFlags  f2);
    ~QLabel_QtDShell();
    ...
    void contextMenuEvent(QContextMenuEvent*  ev0);
    ...
    void focusInEvent(QFocusEvent*  ev0);
    ...
    void __public_linkActivated(const QString&  link0);
    void __public_linkHovered(const QString&  link0);
    ...
    void __override_contextMenuEvent(QContextMenuEvent*  ev0, bool static_call);
    ...
    void __override_focusInEvent(QFocusEvent*  ev0, bool static_call);
