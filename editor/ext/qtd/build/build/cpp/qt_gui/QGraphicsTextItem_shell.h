#ifndef QGRAPHICSTEXTITEM_SHELL_H
#define QGRAPHICSTEXTITEM_SHELL_H
...
class QGraphicsTextItem_QtDShell : public QGraphicsTextItem, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QGraphicsTextItem_QtDShell(void *d_ptr, QGraphicsItem*  parent0, QGraphicsScene*  scene1);
    QGraphicsTextItem_QtDShell(void *d_ptr, const QString&  text0, QGraphicsItem*  parent1, QGraphicsScene*  scene2);
    ~QGraphicsTextItem_QtDShell();
    ...
    void __public_linkActivated(const QString&  arg__1);
    void __public_linkHovered(const QString&  arg__1);
...
#endif // QGRAPHICSTEXTITEM_SHELL_H
