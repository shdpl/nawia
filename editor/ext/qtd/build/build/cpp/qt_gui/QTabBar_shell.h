#ifndef QTABBAR_SHELL_H
#define QTABBAR_SHELL_H
...
class QTabBar_QtDShell : public QTabBar, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTabBar_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QTabBar_QtDShell();
    ...
    void tabInserted(int  index0);
    void tabLayoutChange();
    void tabRemoved(int  index0);
    QSize  tabSizeHint(int  index0) const;
    ...
    void __public_initStyleOption(QStyleOptionTab*  option0, int  tabIndex1) const;
    ...
    void __public_tabCloseRequested(int  index0);
    void __public_tabMoved(int  from0, int  to1);
    ...
    void __override_tabInserted(int  index0, bool static_call);
    void __override_tabLayoutChange(bool static_call);
    void __override_tabRemoved(int  index0, bool static_call);
    QSize  __override_tabSizeHint(int  index0, bool static_call) const;
