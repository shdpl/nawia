#ifndef QDIAL_SHELL_H
#define QDIAL_SHELL_H
...
class QDial_QtDShell : public QDial, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QDial_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QDial_QtDShell();
    ...
    void mouseMoveEvent(QMouseEvent*  me0);
    void mousePressEvent(QMouseEvent*  me0);
    void mouseReleaseEvent(QMouseEvent*  me0);
    void moveEvent(QMoveEvent*  arg__1);
    QPaintEngine*  paintEngine() const;
    void paintEvent(QPaintEvent*  pe0);
    void resizeEvent(QResizeEvent*  re0);
    ...
    void __override_mouseMoveEvent(QMouseEvent*  me0, bool static_call);
    void __override_mousePressEvent(QMouseEvent*  me0, bool static_call);
    void __override_mouseReleaseEvent(QMouseEvent*  me0, bool static_call);
    void __override_moveEvent(QMoveEvent*  arg__1, bool static_call);
    QPaintEngine*  __override_paintEngine(bool static_call) const;
    void __override_paintEvent(QPaintEvent*  pe0, bool static_call);
    void __override_resizeEvent(QResizeEvent*  re0, bool static_call);
