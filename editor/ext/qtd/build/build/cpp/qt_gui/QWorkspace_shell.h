#ifndef QWORKSPACE_SHELL_H
#define QWORKSPACE_SHELL_H
...
class QWorkspace_QtDShell : public QWorkspace, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QWorkspace_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QWorkspace_QtDShell();
    ...
    void __public_windowActivated(QWidget*  w0);
