#ifndef QLISTVIEW_SHELL_H
#define QLISTVIEW_SHELL_H
...
class QListView_QtDShell : public QListView, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QListView_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QListView_QtDShell();
