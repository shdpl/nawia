#ifndef QGRAPHICSWIDGET_SHELL_H
#define QGRAPHICSWIDGET_SHELL_H
...
class QGraphicsWidget_QtDShell : public QGraphicsWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QGraphicsWidget_QtDShell(void *d_ptr, QGraphicsItem*  parent0, Qt::WindowFlags  wFlags1);
    ~QGraphicsWidget_QtDShell();
    ...
    void setGeometry(double  x0, double  y1, double  w2, double  h3);
