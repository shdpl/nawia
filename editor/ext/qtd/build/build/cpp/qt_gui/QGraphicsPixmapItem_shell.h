#ifndef QGRAPHICSPIXMAPITEM_SHELL_H
#define QGRAPHICSPIXMAPITEM_SHELL_H
...
class QGraphicsPixmapItem_QtDShell : public QGraphicsPixmapItem, public QtdObjectLink
{
public:
    QGraphicsPixmapItem_QtDShell(void *d_ptr, QGraphicsItem*  parent0, QGraphicsScene*  scene1);
    QGraphicsPixmapItem_QtDShell(void *d_ptr, const QPixmap&  pixmap0, QGraphicsItem*  parent1, QGraphicsScene*  scene2);
    ~QGraphicsPixmapItem_QtDShell();
...
#endif // QGRAPHICSPIXMAPITEM_SHELL_H
