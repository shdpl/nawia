#ifndef QDOCKWIDGET_SHELL_H
#define QDOCKWIDGET_SHELL_H
...
class QDockWidget_QtDShell : public QDockWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QDockWidget_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  flags1);
    QDockWidget_QtDShell(void *d_ptr, const QString&  title0, QWidget*  parent1, Qt::WindowFlags  flags2);
    ~QDockWidget_QtDShell();
    ...
    void __public_initStyleOption(QStyleOptionDockWidget*  option0) const;
    ...
    void __public_dockLocationChanged(int  area0);
    void __public_featuresChanged(int  features0);
