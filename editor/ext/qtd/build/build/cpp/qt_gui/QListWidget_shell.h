#ifndef QLISTWIDGET_SHELL_H
#define QLISTWIDGET_SHELL_H
...
class QListWidget_QtDShell : public QListWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QListWidget_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QListWidget_QtDShell();
    ...
    bool  dropMimeData(int  index0, const QMimeData*  data1, Qt::DropAction  action2);
    ...
    QMimeData*  mimeData(const QList<QListWidgetItem* >  items0) const;
    ...
    QSize  __public_contentsSize() const;
    ...
    QModelIndex  __public_indexFromItem(QListWidgetItem*  item0) const;
    void __public_internalDrag(int  supportedActions0);
    void __public_internalDrop(QDropEvent*  e0);
    QListWidgetItem*  __public_itemFromIndex(const QModelIndex&  index0) const;
    QList<QListWidgetItem* >  __public_items(const QMimeData*  data0) const;
    QRect  __public_rectForIndex(const QModelIndex&  index0) const;
    void __public_resetInputContext();
    void __public_resizeContents(int  width0, int  height1);
    ...
    void __public_setPositionForIndex(const QPoint&  position0, const QModelIndex&  index1);
    ...
    void __public_currentItemChanged(QListWidgetItem*  current0, QListWidgetItem*  previous1);
    void __public_currentRowChanged(int  currentRow0);
    void __public_currentTextChanged(const QString&  currentText0);
    ...
    void __public_indexesMoved(const QList<QModelIndex >&  indexes0);
    void __public_itemActivated(QListWidgetItem*  item0);
    void __public_itemChanged(QListWidgetItem*  item0);
    void __public_itemClicked(QListWidgetItem*  item0);
    void __public_itemDoubleClicked(QListWidgetItem*  item0);
    void __public_itemEntered(QListWidgetItem*  item0);
    void __public_itemPressed(QListWidgetItem*  item0);
    ...
    bool  __override_dropMimeData(int  index0, const QMimeData*  data1, int  action2, bool static_call);
    ...
    QMimeData*  __override_mimeData(const QList<QListWidgetItem* >  items0, bool static_call) const;
