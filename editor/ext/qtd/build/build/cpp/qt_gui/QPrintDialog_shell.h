#ifndef QPRINTDIALOG_SHELL_H
#define QPRINTDIALOG_SHELL_H
...
class QPrintDialog_QtDShell : public QPrintDialog, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QPrintDialog_QtDShell(void *d_ptr, QPrinter*  printer0, QWidget*  parent1);
    QPrintDialog_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QPrintDialog_QtDShell();
    ...
    void __public_accepted(QPrinter*  printer0);
    ...
    int  __override_exec(bool static_call);
