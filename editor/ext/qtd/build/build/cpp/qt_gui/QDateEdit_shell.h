#ifndef QDATEEDIT_SHELL_H
#define QDATEEDIT_SHELL_H
...
class QDateEdit_QtDShell : public QDateEdit, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QDateEdit_QtDShell(void *d_ptr, QWidget*  parent0);
    QDateEdit_QtDShell(void *d_ptr, const QDate&  date0, QWidget*  parent1);
    ~QDateEdit_QtDShell();
