#ifndef QSPLITTER_SHELL_H
#define QSPLITTER_SHELL_H
...
class QSplitter_QtDShell : public QSplitter, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QSplitter_QtDShell(void *d_ptr, QWidget*  parent0);
    QSplitter_QtDShell(void *d_ptr, Qt::Orientation  arg__1, QWidget*  parent1);
    ~QSplitter_QtDShell();
    ...
    int  __public_closestLegalPosition(int  arg__1, int  arg__2);
    ...
    void __public_moveSplitter(int  pos0, int  index1);
    void __public_resetInputContext();
    QObject*  __public_sender() const;
    void __public_setRubberBand(int  position0);
    void __public_updateMicroFocus();
    void __public_customContextMenuRequested(const QPoint&  pos0);
    void __public_splitterMoved(int  pos0, int  index1);
    ...
    QSplitterHandle*  __override_createHandle(bool static_call);
