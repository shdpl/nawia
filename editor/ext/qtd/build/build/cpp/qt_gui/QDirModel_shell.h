#ifndef QDIRMODEL_SHELL_H
#define QDIRMODEL_SHELL_H
...
class QDirModel_QtDShell : public QDirModel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QDirModel_QtDShell(void *d_ptr, QObject*  parent0);
    QDirModel_QtDShell(void *d_ptr, const QStringList&  nameFilters0, QDir::Filters  filters1, QDir::SortFlags  sort2, QObject*  parent3);
    ~QDirModel_QtDShell();
    ...
    bool  hasChildren(const QModelIndex&  index0) const;
    ...
    bool  __override_hasChildren(const QModelIndex&  index0, bool static_call) const;
