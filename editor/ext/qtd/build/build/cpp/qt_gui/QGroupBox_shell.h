#ifndef QGROUPBOX_SHELL_H
#define QGROUPBOX_SHELL_H
...
class QGroupBox_QtDShell : public QGroupBox, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QGroupBox_QtDShell(void *d_ptr, QWidget*  parent0);
    QGroupBox_QtDShell(void *d_ptr, const QString&  title0, QWidget*  parent1);
    ~QGroupBox_QtDShell();
    ...
    void __public_initStyleOption(QStyleOptionGroupBox*  option0) const;
