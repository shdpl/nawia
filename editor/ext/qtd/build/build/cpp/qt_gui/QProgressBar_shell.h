#ifndef QPROGRESSBAR_SHELL_H
#define QPROGRESSBAR_SHELL_H
...
class QProgressBar_QtDShell : public QProgressBar, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QProgressBar_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QProgressBar_QtDShell();
    ...
    void __public_initStyleOption(QStyleOptionProgressBar*  option0) const;
