#ifndef QTOOLBOX_SHELL_H
#define QTOOLBOX_SHELL_H
...
class QToolBox_QtDShell : public QToolBox, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QToolBox_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  f1);
    ~QToolBox_QtDShell();
    ...
    void itemInserted(int  index0);
    void itemRemoved(int  index0);
    ...
    void __override_itemInserted(int  index0, bool static_call);
    void __override_itemRemoved(int  index0, bool static_call);
