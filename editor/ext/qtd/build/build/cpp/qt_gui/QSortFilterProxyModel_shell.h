#ifndef QSORTFILTERPROXYMODEL_SHELL_H
#define QSORTFILTERPROXYMODEL_SHELL_H
...
class QSortFilterProxyModel_QtDShell : public QSortFilterProxyModel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QSortFilterProxyModel_QtDShell(void *d_ptr, QObject*  parent0);
    ~QSortFilterProxyModel_QtDShell();

    QModelIndex  buddy(const QModelIndex&  index0) const;
    bool  canFetchMore(const QModelIndex&  parent0) const;
    void childEvent(QChildEvent*  arg__1);
    int  columnCount(const QModelIndex&  parent0) const;
    ...
    bool  filterAcceptsColumn(int  source_column0, const QModelIndex&  source_parent1) const;
    bool  filterAcceptsRow(int  source_row0, const QModelIndex&  source_parent1) const;
    Qt::ItemFlags  flags(const QModelIndex&  index0) const;
    bool  hasChildren(const QModelIndex&  parent0) const;
    ...
    bool  lessThan(const QModelIndex&  left0, const QModelIndex&  right1) const;
    QModelIndex  mapFromSource(const QModelIndex&  sourceIndex0) const;
    QItemSelection  mapSelectionFromSource(const QItemSelection&  sourceSelection0) const;
    QItemSelection  mapSelectionToSource(const QItemSelection&  proxySelection0) const;
    QModelIndex  mapToSource(const QModelIndex&  proxyIndex0) const;
    ...
    QModelIndex  parent(const QModelIndex&  child0) const;
    ...
    void setSourceModel(QAbstractItemModel*  sourceModel0);
    ...
    void __public_invalidateFilter();
    ...
    int  __override_columnCount(const QModelIndex&  parent0, bool static_call) const;
    ...
    bool  __override_filterAcceptsColumn(int  source_column0, const QModelIndex&  source_parent1, bool static_call) const;
    bool  __override_filterAcceptsRow(int  source_row0, const QModelIndex&  source_parent1, bool static_call) const;
    int  __override_flags(const QModelIndex&  index0, bool static_call) const;
    bool  __override_hasChildren(const QModelIndex&  parent0, bool static_call) const;
    ...
    bool  __override_lessThan(const QModelIndex&  left0, const QModelIndex&  right1, bool static_call) const;
    QModelIndex  __override_mapFromSource(const QModelIndex&  sourceIndex0, bool static_call) const;
    QItemSelection  __override_mapSelectionFromSource(const QItemSelection&  sourceSelection0, bool static_call) const;
    QItemSelection  __override_mapSelectionToSource(const QItemSelection&  proxySelection0, bool static_call) const;
    QModelIndex  __override_mapToSource(const QModelIndex&  proxyIndex0, bool static_call) const;
    ...
    QModelIndex  __override_parent(const QModelIndex&  child0, bool static_call) const;
    ...
    void __override_setSourceModel(QAbstractItemModel*  sourceModel0, bool static_call);
...
#endif // QSORTFILTERPROXYMODEL_SHELL_H
