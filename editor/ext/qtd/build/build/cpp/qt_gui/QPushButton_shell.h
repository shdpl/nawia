#ifndef QPUSHBUTTON_SHELL_H
#define QPUSHBUTTON_SHELL_H
...
class QPushButton_QtDShell : public QPushButton, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QPushButton_QtDShell(void *d_ptr, QWidget*  parent0);
    QPushButton_QtDShell(void *d_ptr, const QIcon&  icon0, const QString&  text1, QWidget*  parent2);
    QPushButton_QtDShell(void *d_ptr, const QString&  text0, QWidget*  parent1);
    ~QPushButton_QtDShell();
