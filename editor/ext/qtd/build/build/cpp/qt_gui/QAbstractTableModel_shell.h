#ifndef QABSTRACTTABLEMODEL_SHELL_H
#define QABSTRACTTABLEMODEL_SHELL_H
...
class QAbstractTableModel_QtDShell : public QAbstractTableModel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractTableModel_QtDShell(void *d_ptr, QObject*  parent0);
    ~QAbstractTableModel_QtDShell();
...
#endif // QABSTRACTTABLEMODEL_SHELL_H
