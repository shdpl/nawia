#ifndef QPROXYMODEL_SHELL_H
#define QPROXYMODEL_SHELL_H
...
class QProxyModel_QtDShell : public QProxyModel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QProxyModel_QtDShell(void *d_ptr, QObject*  parent0);
    ~QProxyModel_QtDShell();
    ...
    void __public_connectToModel(const QAbstractItemModel*  model0) const;
    ...
    void __public_disconnectFromModel(const QAbstractItemModel*  model0) const;
    ...
    QModelIndex  __public_setProxyModel(const QModelIndex&  source_index0) const;
    QModelIndex  __public_setSourceModel(const QModelIndex&  proxy_index0) const;
