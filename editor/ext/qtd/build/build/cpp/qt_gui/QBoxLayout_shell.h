#ifndef QBOXLAYOUT_SHELL_H
#define QBOXLAYOUT_SHELL_H
...
class QBoxLayout_QtDShell : public QBoxLayout, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QBoxLayout_QtDShell(void *d_ptr, QBoxLayout::Direction  arg__1, QWidget*  parent1);
    ~QBoxLayout_QtDShell();
