#ifndef QSIZEGRIP_SHELL_H
#define QSIZEGRIP_SHELL_H
...
class QSizeGrip_QtDShell : public QSizeGrip, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QSizeGrip_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QSizeGrip_QtDShell();
    ...
    void __override_setVisible(bool  arg__1, bool static_call);
