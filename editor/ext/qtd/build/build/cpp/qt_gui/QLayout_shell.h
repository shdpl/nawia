#ifndef QLAYOUT_SHELL_H
#define QLAYOUT_SHELL_H
...
class QLayout_QtDShell : public QLayout, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QLayout_QtDShell(void *d_ptr);
    QLayout_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QLayout_QtDShell();
