#ifndef QCOLORDIALOG_SHELL_H
#define QCOLORDIALOG_SHELL_H
...
class QColorDialog_QtDShell : public QColorDialog, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QColorDialog_QtDShell(void *d_ptr, QWidget*  parent0);
    QColorDialog_QtDShell(void *d_ptr, const QColor&  initial0, QWidget*  parent1);
    ~QColorDialog_QtDShell();
    ...
    void __public_colorSelected(const QColor&  color0);
    void __public_currentColorChanged(const QColor&  color0);
