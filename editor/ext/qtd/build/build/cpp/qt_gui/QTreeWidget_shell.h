#ifndef QTREEWIDGET_SHELL_H
#define QTREEWIDGET_SHELL_H
...
class QTreeWidget_QtDShell : public QTreeWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTreeWidget_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QTreeWidget_QtDShell();
    ...
    void drawBranches(QPainter*  painter0, const QRect&  rect1, const QModelIndex&  index2) const;
    void drawRow(QPainter*  painter0, const QStyleOptionViewItem&  options1, const QModelIndex&  index2) const;
    void dropEvent(QDropEvent*  event0);
    bool  dropMimeData(QTreeWidgetItem*  parent0, int  index1, const QMimeData*  data2, Qt::DropAction  action3);
    ...
    QMimeData*  mimeData(const QList<QTreeWidgetItem* >  items0) const;
    ...
    void __public_columnMoved();
    void __public_columnResized(int  column0, int  oldSize1, int  newSize2);
    ...
    void __public_drawTree(QPainter*  painter0, const QRegion&  region1) const;
    ...
    QModelIndex  __public_indexFromItem(QTreeWidgetItem*  item0, int  column1) const;
    int  __public_indexRowSizeHint(const QModelIndex&  index0) const;
    QTreeWidgetItem*  __public_itemFromIndex(const QModelIndex&  index0) const;
    void __public_reexpand();
    void __public_resetInputContext();
    int  __public_rowHeight(const QModelIndex&  index0) const;
    void __public_rowsRemoved(const QModelIndex&  parent0, int  first1, int  last2);
    ...
    void __public_collapsed(const QModelIndex&  index0);
    void __public_currentItemChanged(QTreeWidgetItem*  current0, QTreeWidgetItem*  previous1);
    ...
    void __public_expanded(const QModelIndex&  index0);
    void __public_itemActivated(QTreeWidgetItem*  item0, int  column1);
    void __public_itemChanged(QTreeWidgetItem*  item0, int  column1);
    void __public_itemClicked(QTreeWidgetItem*  item0, int  column1);
    void __public_itemCollapsed(QTreeWidgetItem*  item0);
    void __public_itemDoubleClicked(QTreeWidgetItem*  item0, int  column1);
    void __public_itemEntered(QTreeWidgetItem*  item0, int  column1);
    void __public_itemExpanded(QTreeWidgetItem*  item0);
    void __public_itemPressed(QTreeWidgetItem*  item0, int  column1);
    void __public_itemSelectionChanged();
    ...
    void __override_drawBranches(QPainter*  painter0, const QRect&  rect1, const QModelIndex&  index2, bool static_call) const;
    void __override_drawRow(QPainter*  painter0, const QStyleOptionViewItem&  options1, const QModelIndex&  index2, bool static_call) const;
    void __override_dropEvent(QDropEvent*  event0, bool static_call);
    bool  __override_dropMimeData(QTreeWidgetItem*  parent0, int  index1, const QMimeData*  data2, int  action3, bool static_call);
    ...
    QMimeData*  __override_mimeData(const QList<QTreeWidgetItem* >  items0, bool static_call) const;
