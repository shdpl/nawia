#ifndef QMAINWINDOW_SHELL_H
#define QMAINWINDOW_SHELL_H
...
class QMainWindow_QtDShell : public QMainWindow, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QMainWindow_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  flags1);
    ~QMainWindow_QtDShell();
    ...
    QMenu*  __override_createPopupMenu(bool static_call);
