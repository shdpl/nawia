#ifndef QUNDOVIEW_SHELL_H
#define QUNDOVIEW_SHELL_H
...
class QUndoView_QtDShell : public QUndoView, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QUndoView_QtDShell(void *d_ptr, QUndoGroup*  group0, QWidget*  parent1);
    QUndoView_QtDShell(void *d_ptr, QUndoStack*  stack0, QWidget*  parent1);
    QUndoView_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QUndoView_QtDShell();
