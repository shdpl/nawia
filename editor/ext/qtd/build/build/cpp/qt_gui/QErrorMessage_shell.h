#ifndef QERRORMESSAGE_SHELL_H
#define QERRORMESSAGE_SHELL_H
...
class QErrorMessage_QtDShell : public QErrorMessage, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QErrorMessage_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QErrorMessage_QtDShell();
