#ifndef QABSTRACTPROXYMODEL_SHELL_H
#define QABSTRACTPROXYMODEL_SHELL_H
...
class QAbstractProxyModel_QtDShell : public QAbstractProxyModel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractProxyModel_QtDShell(void *d_ptr, QObject*  parent0);
    ~QAbstractProxyModel_QtDShell();
    ...
    QVariant  data(const QModelIndex&  proxyIndex0, int  role1) const;
    ...
    QItemSelection  mapSelectionFromSource(const QItemSelection&  selection0) const;
    QItemSelection  mapSelectionToSource(const QItemSelection&  selection0) const;
    ...
    QVariant  __override_data(const QModelIndex&  proxyIndex0, int  role1, bool static_call) const;
    ...
    QItemSelection  __override_mapSelectionFromSource(const QItemSelection&  selection0, bool static_call) const;
    QItemSelection  __override_mapSelectionToSource(const QItemSelection&  selection0, bool static_call) const;
...
#endif // QABSTRACTPROXYMODEL_SHELL_H
