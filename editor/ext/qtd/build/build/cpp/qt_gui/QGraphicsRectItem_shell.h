#ifndef QGRAPHICSRECTITEM_SHELL_H
#define QGRAPHICSRECTITEM_SHELL_H
...
class QGraphicsRectItem_QtDShell : public QGraphicsRectItem, public QtdObjectLink
{
public:
    QGraphicsRectItem_QtDShell(void *d_ptr, QGraphicsItem*  parent0, QGraphicsScene*  scene1);
    QGraphicsRectItem_QtDShell(void *d_ptr, const QRectF&  rect0, QGraphicsItem*  parent1, QGraphicsScene*  scene2);
    QGraphicsRectItem_QtDShell(void *d_ptr, double  x0, double  y1, double  w2, double  h3, QGraphicsItem*  parent4, QGraphicsScene*  scene5);
    ~QGraphicsRectItem_QtDShell();
...
#endif // QGRAPHICSRECTITEM_SHELL_H
