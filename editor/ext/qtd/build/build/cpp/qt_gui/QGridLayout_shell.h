#ifndef QGRIDLAYOUT_SHELL_H
#define QGRIDLAYOUT_SHELL_H
...
class QGridLayout_QtDShell : public QGridLayout, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QGridLayout_QtDShell(void *d_ptr);
    QGridLayout_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QGridLayout_QtDShell();
    ...
    QWidget*  widget();
    void addItem(QLayoutItem*  item0, int  row1, int  column2, int  rowSpan3, int  columnSpan4, Qt::Alignment  arg__6);
