#ifndef QTABWIDGET_SHELL_H
#define QTABWIDGET_SHELL_H
...
class QTabWidget_QtDShell : public QTabWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTabWidget_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QTabWidget_QtDShell();
    ...
    void __public_initStyleOption(QStyleOptionTabWidgetFrame*  option0) const;
    void __public_resetInputContext();
    QObject*  __public_sender() const;
    void __public_setTabBar(QTabBar*  arg__1);
    QTabBar*  __public_tabBar() const;
