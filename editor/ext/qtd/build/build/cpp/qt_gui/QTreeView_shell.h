#ifndef QTREEVIEW_SHELL_H
#define QTREEVIEW_SHELL_H
...
class QTreeView_QtDShell : public QTreeView, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTreeView_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QTreeView_QtDShell();
