#ifndef QTEXTBROWSER_SHELL_H
#define QTEXTBROWSER_SHELL_H
...
class QTextBrowser_QtDShell : public QTextBrowser, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTextBrowser_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QTextBrowser_QtDShell();
    ...
    void focusOutEvent(QFocusEvent*  ev0);
    void forward();
    ...
    void setSource(const QUrl&  name0);
    ...
    void __public_anchorClicked(const QUrl&  arg__1);
    void __public_backwardAvailable(bool  arg__1);
    ...
    void __public_forwardAvailable(bool  arg__1);
    void __public_highlighted(const QString&  arg__1);
    void __public_highlighted(const QUrl&  arg__1);
    void __public_historyChanged();
    void __public_redoAvailable(bool  b0);
    void __public_selectionChanged();
    void __public_sourceChanged(const QUrl&  arg__1);
    ...
    void __override_backward(bool static_call);
    ...
    void __override_focusOutEvent(QFocusEvent*  ev0, bool static_call);
    void __override_forward(bool static_call);
    ...
    void __override_home(bool static_call);
    ...
    void __override_reload(bool static_call);
    ...
    void __override_setSource(const QUrl&  name0, bool static_call);
