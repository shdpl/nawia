#ifndef QCDESTYLE_SHELL_H
#define QCDESTYLE_SHELL_H
...
class QCDEStyle_QtDShell : public QCDEStyle, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QCDEStyle_QtDShell(void *d_ptr, bool  useHighlightCols0);
    ~QCDEStyle_QtDShell();
