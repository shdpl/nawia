#ifndef QGRAPHICSPATHITEM_SHELL_H
#define QGRAPHICSPATHITEM_SHELL_H
...
class QGraphicsPathItem_QtDShell : public QGraphicsPathItem, public QtdObjectLink
{
public:
    QGraphicsPathItem_QtDShell(void *d_ptr, QGraphicsItem*  parent0, QGraphicsScene*  scene1);
    QGraphicsPathItem_QtDShell(void *d_ptr, const QPainterPath&  path0, QGraphicsItem*  parent1, QGraphicsScene*  scene2);
    ~QGraphicsPathItem_QtDShell();
...
#endif // QGRAPHICSPATHITEM_SHELL_H
