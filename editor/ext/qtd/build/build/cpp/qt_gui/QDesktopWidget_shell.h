#ifndef QDESKTOPWIDGET_SHELL_H
#define QDESKTOPWIDGET_SHELL_H
...
class QDesktopWidget_QtDShell : public QDesktopWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QDesktopWidget_QtDShell(void *d_ptr);
    ~QDesktopWidget_QtDShell();
    ...
    void __public_resized(int  arg__1);
    void __public_screenCountChanged(int  arg__1);
    void __public_workAreaResized(int  arg__1);
