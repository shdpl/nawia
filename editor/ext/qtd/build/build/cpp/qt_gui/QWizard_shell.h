#ifndef QWIZARD_SHELL_H
#define QWIZARD_SHELL_H
...
class QWizard_QtDShell : public QWizard, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QWizard_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  flags1);
    ~QWizard_QtDShell();
    ...
    void __public_currentIdChanged(int  id0);
    void __public_customButtonClicked(int  which0);
    void __public_customContextMenuRequested(const QPoint&  pos0);
    void __public_finished(int  result0);
    void __public_helpRequested();
    void __public_pageAdded(int  id0);
    void __public_pageRemoved(int  id0);
    ...
    void __override_cleanupPage(int  id0, bool static_call);
    ...
    void __override_initializePage(int  id0, bool static_call);
    ...
    bool  __override_validateCurrentPage(bool static_call);
    void __override_wheelEvent(QWheelEvent*  arg__1, bool static_call);
};

#endif // QWIZARD_SHELL_H
