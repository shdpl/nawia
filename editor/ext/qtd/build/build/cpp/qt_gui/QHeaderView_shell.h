#ifndef QHEADERVIEW_SHELL_H
#define QHEADERVIEW_SHELL_H
...
class QHeaderView_QtDShell : public QHeaderView, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QHeaderView_QtDShell(void *d_ptr, Qt::Orientation  orientation0, QWidget*  parent1);
    ~QHeaderView_QtDShell();
    ...
    void currentChanged(const QModelIndex&  current0, const QModelIndex&  old1);
    ...
    QModelIndex  moveCursor(QAbstractItemView::CursorAction  arg__1, Qt::KeyboardModifiers  arg__2);
    void moveEvent(QMoveEvent*  arg__1);
    QPaintEngine*  paintEngine() const;
    void paintEvent(QPaintEvent*  e0);
    void paintSection(QPainter*  painter0, const QRect&  rect1, int  logicalIndex2) const;
    void reset();
    ...
    QSize  sectionSizeFromContents(int  logicalIndex0) const;
    void selectAll();
    ...
    void setSelection(const QRect&  rect0, QItemSelectionModel::SelectionFlags  flags1);
    ...
    void __public_initStyleOption(QStyleOptionHeader*  option0) const;
    void __public_initialize();
    void __public_initializeSections();
    void __public_initializeSections(int  start0, int  end1);
    void __public_resetInputContext();
    void __public_resizeSections();
    void __public_scheduleDelayedItemsLayout();
    void __public_scrollDirtyRegion(int  dx0, int  dy1);
    void __public_sectionsAboutToBeRemoved(const QModelIndex&  parent0, int  logicalFirst1, int  logicalLast2);
    void __public_sectionsInserted(const QModelIndex&  parent0, int  logicalFirst1, int  logicalLast2);
    ...
    void __public_updateSection(int  logicalIndex0);
    ...
    void __public_geometriesChanged();
    void __public_pressed(const QModelIndex&  index0);
    void __public_sectionAutoResize(int  logicalIndex0, int  mode1);
    void __public_sectionClicked(int  logicalIndex0);
    void __public_sectionCountChanged(int  oldCount0, int  newCount1);
    void __public_sectionDoubleClicked(int  logicalIndex0);
    void __public_sectionEntered(int  logicalIndex0);
    void __public_sectionHandleDoubleClicked(int  logicalIndex0);
    void __public_sectionMoved(int  logicalIndex0, int  oldVisualIndex1, int  newVisualIndex2);
    void __public_sectionPressed(int  logicalIndex0);
    void __public_sectionResized(int  logicalIndex0, int  oldSize1, int  newSize2);
    void __public_sortIndicatorChanged(int  logicalIndex0, int  order1);
    ...
    void __override_currentChanged(const QModelIndex&  current0, const QModelIndex&  old1, bool static_call);
    ...
    QModelIndex  __override_moveCursor(int  arg__1, int  arg__2, bool static_call);
    ...
    void __override_paintSection(QPainter*  painter0, const QRect&  rect1, int  logicalIndex2, bool static_call) const;
    ...
    QSize  __override_sectionSizeFromContents(int  logicalIndex0, bool static_call) const;
    ...
    void __override_setSelection(const QRect&  rect0, int  flags1, bool static_call);
    ...
    bool  __override_viewportEvent(QEvent*  e0, bool static_call);
