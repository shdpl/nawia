#ifndef QFOCUSFRAME_SHELL_H
#define QFOCUSFRAME_SHELL_H
...
class QFocusFrame_QtDShell : public QFocusFrame, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QFocusFrame_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QFocusFrame_QtDShell();
    ...
    void __public_initStyleOption(QStyleOption*  option0) const;
