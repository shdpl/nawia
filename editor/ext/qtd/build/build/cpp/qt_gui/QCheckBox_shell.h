#ifndef QCHECKBOX_SHELL_H
#define QCHECKBOX_SHELL_H
...
class QCheckBox_QtDShell : public QCheckBox, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QCheckBox_QtDShell(void *d_ptr, QWidget*  parent0);
    QCheckBox_QtDShell(void *d_ptr, const QString&  text0, QWidget*  parent1);
    ~QCheckBox_QtDShell();
