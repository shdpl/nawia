#ifndef QGRAPHICSPOLYGONITEM_SHELL_H
#define QGRAPHICSPOLYGONITEM_SHELL_H
...
class QGraphicsPolygonItem_QtDShell : public QGraphicsPolygonItem, public QtdObjectLink
{
public:
    QGraphicsPolygonItem_QtDShell(void *d_ptr, QGraphicsItem*  parent0, QGraphicsScene*  scene1);
    QGraphicsPolygonItem_QtDShell(void *d_ptr, const QPolygonF&  polygon0, QGraphicsItem*  parent1, QGraphicsScene*  scene2);
    ~QGraphicsPolygonItem_QtDShell();
...
#endif // QGRAPHICSPOLYGONITEM_SHELL_H
