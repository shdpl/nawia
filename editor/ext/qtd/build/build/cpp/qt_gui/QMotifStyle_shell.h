#ifndef QMOTIFSTYLE_SHELL_H
#define QMOTIFSTYLE_SHELL_H
...
class QMotifStyle_QtDShell : public QMotifStyle, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QMotifStyle_QtDShell(void *d_ptr, bool  useHighlightCols0);
    ~QMotifStyle_QtDShell();
