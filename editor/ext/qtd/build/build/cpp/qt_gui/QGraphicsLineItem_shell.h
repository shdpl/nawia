#ifndef QGRAPHICSLINEITEM_SHELL_H
#define QGRAPHICSLINEITEM_SHELL_H
...
class QGraphicsLineItem_QtDShell : public QGraphicsLineItem, public QtdObjectLink
{
public:
    QGraphicsLineItem_QtDShell(void *d_ptr, QGraphicsItem*  parent0, QGraphicsScene*  scene1);
    QGraphicsLineItem_QtDShell(void *d_ptr, const QLineF&  line0, QGraphicsItem*  parent1, QGraphicsScene*  scene2);
    QGraphicsLineItem_QtDShell(void *d_ptr, double  x10, double  y11, double  x22, double  y23, QGraphicsItem*  parent4, QGraphicsScene*  scene5);
    ~QGraphicsLineItem_QtDShell();
...
#endif // QGRAPHICSLINEITEM_SHELL_H
