#ifndef QHBOXLAYOUT_SHELL_H
#define QHBOXLAYOUT_SHELL_H
...
class QHBoxLayout_QtDShell : public QHBoxLayout, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QHBoxLayout_QtDShell(void *d_ptr);
    QHBoxLayout_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QHBoxLayout_QtDShell();
