#ifndef QPROGRESSDIALOG_SHELL_H
#define QPROGRESSDIALOG_SHELL_H
...
class QProgressDialog_QtDShell : public QProgressDialog, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QProgressDialog_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  flags1);
    QProgressDialog_QtDShell(void *d_ptr, const QString&  labelText0, const QString&  cancelButtonText1, int  minimum2, int  maximum3, QWidget*  parent4, Qt::WindowFlags  flags5);
    ~QProgressDialog_QtDShell();
