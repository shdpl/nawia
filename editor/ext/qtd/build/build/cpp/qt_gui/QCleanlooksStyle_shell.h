#ifndef QCLEANLOOKSSTYLE_SHELL_H
#define QCLEANLOOKSSTYLE_SHELL_H
...
class QCleanlooksStyle_QtDShell : public QCleanlooksStyle, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QCleanlooksStyle_QtDShell(void *d_ptr);
    ~QCleanlooksStyle_QtDShell();
    ...
    void drawControl(QStyle::ControlElement  ce0, const QStyleOption*  option1, QPainter*  painter2, const QWidget*  widget3) const;
    ...
    void drawPrimitive(QStyle::PrimitiveElement  elem0, const QStyleOption*  option1, QPainter*  painter2, const QWidget*  widget3) const;
    ...
    void __override_drawControl(int  ce0, const QStyleOption*  option1, QPainter*  painter2, const QWidget*  widget3, bool static_call) const;
    ...
    void __override_drawPrimitive(int  elem0, const QStyleOption*  option1, QPainter*  painter2, const QWidget*  widget3, bool static_call) const;
...
#endif // QCLEANLOOKSSTYLE_SHELL_H
