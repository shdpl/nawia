#ifndef QMENU_SHELL_H
#define QMENU_SHELL_H
...
class QMenu_QtDShell : public QMenu, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QMenu_QtDShell(void *d_ptr, QWidget*  parent0);
    QMenu_QtDShell(void *d_ptr, const QString&  title0, QWidget*  parent1);
    ~QMenu_QtDShell();
    ...
    int  __public_columnCount() const;
    ...
    void __public_initStyleOption(QStyleOptionMenuItem*  option0, const QAction*  action1) const;
    void __public_resetInputContext();
    QObject*  __public_sender() const;
    void __public_updateMicroFocus();
    void __public_aboutToHide();
    void __public_aboutToShow();
    void __public_customContextMenuRequested(const QPoint&  pos0);
    void __public_hovered(QAction*  action0);
    void __public_triggered(QAction*  action0);
