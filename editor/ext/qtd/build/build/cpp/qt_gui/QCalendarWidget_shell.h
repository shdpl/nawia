#ifndef QCALENDARWIDGET_SHELL_H
#define QCALENDARWIDGET_SHELL_H
...
class QCalendarWidget_QtDShell : public QCalendarWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QCalendarWidget_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QCalendarWidget_QtDShell();
    ...
    void paintCell(QPainter*  painter0, const QRect&  rect1, const QDate&  date2) const;
    ...
    void __public_updateCell(const QDate&  date0);
    void __public_updateCells();
    void __public_updateMicroFocus();
    void __public_activated(const QDate&  date0);
    void __public_clicked(const QDate&  date0);
    void __public_currentPageChanged(int  year0, int  month1);
    ...
    void __override_paintCell(QPainter*  painter0, const QRect&  rect1, const QDate&  date2, bool static_call) const;
