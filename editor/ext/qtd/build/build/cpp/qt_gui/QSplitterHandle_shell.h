#ifndef QSPLITTERHANDLE_SHELL_H
#define QSPLITTERHANDLE_SHELL_H
...
class QSplitterHandle_QtDShell : public QSplitterHandle, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QSplitterHandle_QtDShell(void *d_ptr, Qt::Orientation  o0, QSplitter*  parent1);
    ~QSplitterHandle_QtDShell();
    ...
    int  __public_closestLegalPosition(int  p0);
    ...
    void __public_moveSplitter(int  p0);
