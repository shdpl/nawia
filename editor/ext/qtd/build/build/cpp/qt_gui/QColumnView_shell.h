#ifndef QCOLUMNVIEW_SHELL_H
#define QCOLUMNVIEW_SHELL_H
...
class QColumnView_QtDShell : public QColumnView, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QColumnView_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QColumnView_QtDShell();
    ...
    QAbstractItemView*  createColumn(const QModelIndex&  rootIndex0);
    ...
    QModelIndex  indexAt(const QPoint&  point0) const;
    ...
    void __public_initializeColumn(QAbstractItemView*  column0) const;
    ...
    void __public_updatePreviewWidget(const QModelIndex&  index0);
    ...
    QAbstractItemView*  __override_createColumn(const QModelIndex&  rootIndex0, bool static_call);
    ...
    QModelIndex  __override_indexAt(const QPoint&  point0, bool static_call) const;
