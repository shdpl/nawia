#ifndef QGRAPHICSPROXYWIDGET_SHELL_H
#define QGRAPHICSPROXYWIDGET_SHELL_H
...
class QGraphicsProxyWidget_QtDShell : public QGraphicsProxyWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QGraphicsProxyWidget_QtDShell(void *d_ptr, QGraphicsItem*  parent0, Qt::WindowFlags  wFlags1);
    ~QGraphicsProxyWidget_QtDShell();
    ...
    void grabKeyboardEvent(QEvent*  event0);
    void grabMouseEvent(QEvent*  event0);
    ...
    void initStyleOption(QStyleOption*  option0) const;
    ...
    void moveEvent(QGraphicsSceneMoveEvent*  event0);
    QPainterPath  opaqueArea() const;
    void paint(QPainter*  painter0, const QStyleOptionGraphicsItem*  option1, QWidget*  widget2);
    void paintWindowFrame(QPainter*  painter0, const QStyleOptionGraphicsItem*  option1, QWidget*  widget2);
    void polishEvent();
    QVariant  propertyChange(const QString&  propertyName0, const QVariant&  value1);
    void resizeEvent(QGraphicsSceneResizeEvent*  event0);
    ...
    int  type() const;
    void ungrabKeyboardEvent(QEvent*  event0);
    void ungrabMouseEvent(QEvent*  event0);
    void updateGeometry();
    void wheelEvent(QGraphicsSceneWheelEvent*  event0);
    bool  windowFrameEvent(QEvent*  e0);
    Qt::WindowFrameSection  windowFrameSectionAt(const QPointF&  pos0) const;
    void __public_addToIndex();
    QGraphicsProxyWidget*  __public_newProxyWidget(const QWidget*  arg__1);
    ...
    void __override_grabKeyboardEvent(QEvent*  event0, bool static_call);
    void __override_grabMouseEvent(QEvent*  event0, bool static_call);
    ...
    void __override_initStyleOption(QStyleOption*  option0, bool static_call) const;
    ...
    void __override_moveEvent(QGraphicsSceneMoveEvent*  event0, bool static_call);
    ...
    void __override_paintWindowFrame(QPainter*  painter0, const QStyleOptionGraphicsItem*  option1, QWidget*  widget2, bool static_call);
    void __override_polishEvent(bool static_call);
    QVariant  __override_propertyChange(const QString&  propertyName0, const QVariant&  value1, bool static_call);
    void __override_resizeEvent(QGraphicsSceneResizeEvent*  event0, bool static_call);
    ...
    void __override_ungrabKeyboardEvent(QEvent*  event0, bool static_call);
    void __override_ungrabMouseEvent(QEvent*  event0, bool static_call);
    ...
    bool  __override_windowFrameEvent(QEvent*  e0, bool static_call);
    int  __override_windowFrameSectionAt(const QPointF&  pos0, bool static_call) const;
};

#endif // QGRAPHICSPROXYWIDGET_SHELL_H
