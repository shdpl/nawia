#ifndef QABSTRACTSPINBOX_SHELL_H
#define QABSTRACTSPINBOX_SHELL_H
...
class QAbstractSpinBox_QtDShell : public QAbstractSpinBox, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractSpinBox_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QAbstractSpinBox_QtDShell();
...
#endif // QABSTRACTSPINBOX_SHELL_H
