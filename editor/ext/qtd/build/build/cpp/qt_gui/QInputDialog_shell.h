#ifndef QINPUTDIALOG_SHELL_H
#define QINPUTDIALOG_SHELL_H
...
class QInputDialog_QtDShell : public QInputDialog, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QInputDialog_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  flags1);
    ~QInputDialog_QtDShell();
    ...
    void __public_doubleValueChanged(double  value0);
    void __public_doubleValueSelected(double  value0);
    void __public_finished(int  result0);
    void __public_intValueChanged(int  value0);
    void __public_intValueSelected(int  value0);
    void __public_rejected();
    void __public_textValueChanged(const QString&  text0);
    void __public_textValueSelected(const QString&  text0);
