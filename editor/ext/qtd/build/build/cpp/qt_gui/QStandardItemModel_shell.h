#ifndef QSTANDARDITEMMODEL_SHELL_H
#define QSTANDARDITEMMODEL_SHELL_H
...
class QStandardItemModel_QtDShell : public QStandardItemModel, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QStandardItemModel_QtDShell(void *d_ptr, QObject*  parent0);
    QStandardItemModel_QtDShell(void *d_ptr, int  rows0, int  columns1, QObject*  parent2);
    ~QStandardItemModel_QtDShell();
    ...
    void __public_itemChanged(QStandardItem*  item0);
...
#endif // QSTANDARDITEMMODEL_SHELL_H
