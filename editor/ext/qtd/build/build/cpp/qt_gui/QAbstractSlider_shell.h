#ifndef QABSTRACTSLIDER_SHELL_H
#define QABSTRACTSLIDER_SHELL_H
...
class QAbstractSlider_QtDShell : public QAbstractSlider, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractSlider_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QAbstractSlider_QtDShell();
