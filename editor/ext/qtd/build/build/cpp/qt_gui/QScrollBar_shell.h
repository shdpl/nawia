#ifndef QSCROLLBAR_SHELL_H
#define QSCROLLBAR_SHELL_H
...
class QScrollBar_QtDShell : public QScrollBar, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QScrollBar_QtDShell(void *d_ptr, QWidget*  parent0);
    QScrollBar_QtDShell(void *d_ptr, Qt::Orientation  arg__1, QWidget*  parent1);
    ~QScrollBar_QtDShell();
