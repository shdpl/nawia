#ifndef QSPINBOX_SHELL_H
#define QSPINBOX_SHELL_H
...
class QSpinBox_QtDShell : public QSpinBox, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QSpinBox_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QSpinBox_QtDShell();
    ...
    void __public_valueChanged(int  arg__1);
    ...
    QString  __override_textFromValue(int  val0, bool static_call) const;
    ...
    int  __override_valueFromText(const QString&  text0, bool static_call) const;
    void __override_wheelEvent(QWheelEvent*  event0, bool static_call);
};

#endif // QSPINBOX_SHELL_H
