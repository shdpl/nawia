#ifndef QTABLEWIDGET_SHELL_H
#define QTABLEWIDGET_SHELL_H
...
class QTableWidget_QtDShell : public QTableWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QTableWidget_QtDShell(void *d_ptr, QWidget*  parent0);
    QTableWidget_QtDShell(void *d_ptr, int  rows0, int  columns1, QWidget*  parent2);
    ~QTableWidget_QtDShell();
    ...
    bool  dropMimeData(int  row0, int  column1, const QMimeData*  data2, Qt::DropAction  action3);
    ...
    QMimeData*  mimeData(const QList<QTableWidgetItem* >  items0) const;
    ...
    QModelIndex  __public_indexFromItem(QTableWidgetItem*  item0) const;
    QTableWidgetItem*  __public_itemFromIndex(const QModelIndex&  index0) const;
    QList<QTableWidgetItem* >  __public_items(const QMimeData*  data0) const;
    ...
    void __public_cellActivated(int  row0, int  column1);
    void __public_cellChanged(int  row0, int  column1);
    void __public_cellClicked(int  row0, int  column1);
    void __public_cellDoubleClicked(int  row0, int  column1);
    void __public_cellEntered(int  row0, int  column1);
    void __public_cellPressed(int  row0, int  column1);
    void __public_clicked(const QModelIndex&  index0);
    void __public_currentCellChanged(int  currentRow0, int  currentColumn1, int  previousRow2, int  previousColumn3);
    void __public_currentItemChanged(QTableWidgetItem*  current0, QTableWidgetItem*  previous1);
    ...
    void __public_itemActivated(QTableWidgetItem*  item0);
    void __public_itemChanged(QTableWidgetItem*  item0);
    void __public_itemClicked(QTableWidgetItem*  item0);
    void __public_itemDoubleClicked(QTableWidgetItem*  item0);
    void __public_itemEntered(QTableWidgetItem*  item0);
    void __public_itemPressed(QTableWidgetItem*  item0);
    ...
    bool  __override_dropMimeData(int  row0, int  column1, const QMimeData*  data2, int  action3, bool static_call);
    ...
    QMimeData*  __override_mimeData(const QList<QTableWidgetItem* >  items0, bool static_call) const;
