#ifndef QLCDNUMBER_SHELL_H
#define QLCDNUMBER_SHELL_H
...
class QLCDNumber_QtDShell : public QLCDNumber, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QLCDNumber_QtDShell(void *d_ptr, QWidget*  parent0);
    QLCDNumber_QtDShell(void *d_ptr, uint  numDigits0, QWidget*  parent1);
    ~QLCDNumber_QtDShell();
