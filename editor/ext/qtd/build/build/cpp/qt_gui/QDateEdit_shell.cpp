...
class QDateEditEntity : public QObject, public QObjectLink
{
public:
    Q_OBJECT_CHECK
//    virtual int qt_metacall(QMetaObject::Call, int, void **);

    QDateEditEntity(QObject *qObject, void *dId) : QObject(), QObjectLink(qObject, dId) {}
};

QTD_EXTERN QTD_EXPORT void qtd_QDateEdit_createEntity(void *nativeId, void* dId)
{
    new QDateEditEntity((QObject*)nativeId, dId);
}

QDateEdit_QtDShell::QDateEdit_QtDShell(void *d_ptr, QWidget*  parent0)
    : QDateEdit(parent0),
      QObjectLink(this, d_ptr)
{
}

QDateEdit_QtDShell::QDateEdit_QtDShell(void *d_ptr, const QDate&  date0, QWidget*  parent1)
    : QDateEdit(date0, parent1),
      QObjectLink(this, d_ptr)
{
}
...
const QMetaObject * QDateEdit_QtDShell::metaObject() const
{
...
int QDateEdit_QtDShell::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    void* dId = QObjectLink::getDId(this);
    if (dId)
        return qtd_QObject_qt_metacall_dispatch(dId, _c, _id, _a);
    else
        return QDateEdit::qt_metacall(_c, _id, _a);
}

int QDateEdit_QtDShell::__override_qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    return QDateEdit::qt_metacall(_c, _id, _a);}

QTD_EXTERN QTD_EXPORT int qtd_QDateEdit_qt_metacall(void* __this_nativeId, QMetaObject::Call _c, int _id, void **_a){
    QDateEdit_QtDShell *__qt_this = (QDateEdit_QtDShell *) __this_nativeId;
    return __qt_this->__override_qt_metacall(_c, _id, _a);
}

// Virtual overrides
QTD_FUNC_DECL(GUI, void, QWidget_actionEvent_QActionEvent_dispatch, (void *dId, void* arg__1))
void QDateEdit_QtDShell::actionEvent(QActionEvent*  arg__1)
{
    qtd_QWidget_actionEvent_QActionEvent_dispatch(QObjectLink::getLink(this)->dId, (QActionEvent* )arg__1);
}

QTD_FUNC_DECL(GUI, void, QWidget_changeEvent_QEvent_dispatch, (void *dId, void* event0))
void QDateEdit_QtDShell::changeEvent(QEvent*  event0)
{
    qtd_QWidget_changeEvent_QEvent_dispatch(QObjectLink::getLink(this)->dId, (QEvent* )event0);
}

QTD_FUNC_DECL(GUI, void, QObject_childEvent_QChildEvent_dispatch, (void *dId, void* arg__1))
void QDateEdit_QtDShell::childEvent(QChildEvent*  arg__1)
{
    qtd_QObject_childEvent_QChildEvent_dispatch(QObjectLink::getLink(this)->dId, (QChildEvent* )arg__1);
}

QTD_FUNC_DECL(GUI, void, QAbstractSpinBox_clear_dispatch, (void *dId))
void QDateEdit_QtDShell::clear()
{
...
void QDateEdit_QtDShell::closeEvent(QCloseEvent*  event0)
{
...
void QDateEdit_QtDShell::contextMenuEvent(QContextMenuEvent*  event0)
{
...
void QDateEdit_QtDShell::customEvent(QEvent*  arg__1)
{
...
QDateTime  QDateEdit_QtDShell::dateTimeFromText(const QString&  text0) const
{
...
void QDateEdit_QtDShell::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QDateEdit_QtDShell::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QDateEdit_QtDShell::fixup(QString&  input0) const
{
...
void QDateEdit_QtDShell::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QDateEdit_QtDShell::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QDateEdit_QtDShell::keyPressEvent(QKeyEvent*  event0)
{
...
void QDateEdit_QtDShell::keyReleaseEvent(QKeyEvent*  event0)
{
    qtd_QWidget_keyReleaseEvent_QKeyEvent_dispatch(QObjectLink::getLink(this)->dId, (QKeyEvent* )event0);
}

QTD_FUNC_DECL(GUI, void, QWidget_languageChange_dispatch, (void *dId))
void QDateEdit_QtDShell::languageChange()
{
    qtd_QWidget_languageChange_dispatch(QObjectLink::getLink(this)->dId);
}

QTD_FUNC_DECL(GUI, void, QWidget_leaveEvent_QEvent_dispatch, (void *dId, void* arg__1))
void QDateEdit_QtDShell::leaveEvent(QEvent*  arg__1)
{
    qtd_QWidget_leaveEvent_QEvent_dispatch(QObjectLink::getLink(this)->dId, (QEvent* )arg__1);
}

QTD_FUNC_DECL(GUI, int, QPaintDevice_metric_PaintDeviceMetric_const_dispatch, (void *dId, int arg__1))
int  QDateEdit_QtDShell::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
    return qtd_QPaintDevice_metric_PaintDeviceMetric_const_dispatch(QObjectLink::getLink(this)->dId, (QPaintDevice::PaintDeviceMetric )arg__1);
}

QTD_FUNC_DECL(GUI, void, QWidget_minimumSizeHint_const_dispatch, (void *dId, QSize *__d_return_value))
QSize  QDateEdit_QtDShell::minimumSizeHint() const
{
...
void QDateEdit_QtDShell::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QDateEdit_QtDShell::mouseMoveEvent(QMouseEvent*  event0)
{
...
void QDateEdit_QtDShell::mousePressEvent(QMouseEvent*  event0)
{
...
void QDateEdit_QtDShell::stepBy(int  steps0)
{
...
QAbstractSpinBox::StepEnabled  QDateEdit_QtDShell::stepEnabled() const
{
...
void QDateEdit_QtDShell::tabletEvent(QTabletEvent*  arg__1)
{
...
QString  QDateEdit_QtDShell::textFromDateTime(const QDateTime&  dt0) const
{
    DArray ret_str;
...
void QDateEdit_QtDShell::timerEvent(QTimerEvent*  event0)
{
...
QValidator::State  QDateEdit_QtDShell::validate(QString&  input0, int&  pos1) const
{
...
void QDateEdit_QtDShell::wheelEvent(QWheelEvent*  event0)
{
    qtd_QWidget_wheelEvent_QWheelEvent_dispatch(QObjectLink::getLink(this)->dId, (QWheelEvent* )event0);
}

QTD_EXTERN QTD_EXPORT void qtd_QDateEdit_initCallBacks(VoidFunc *virts) {
}
// Functions in shell class
// public overrides for functions that are protected in the base class
void QDateEdit_QtDShell::__public_destroy(bool  destroyWindow0, bool  destroySubWindows1)
{
    QWidget::destroy((bool )destroyWindow0, (bool )destroySubWindows1);
}

bool  QDateEdit_QtDShell::__public_focusNextChild()
{
    return QWidget::focusNextChild();
}

bool  QDateEdit_QtDShell::__public_focusPreviousChild()
{
    return QWidget::focusPreviousChild();
}

void QDateEdit_QtDShell::__public_initStyleOption(QStyleOptionSpinBox*  option0) const
{
    QDateTimeEdit::initStyleOption((QStyleOptionSpinBox* )option0);
}

QLineEdit*  QDateEdit_QtDShell::__public_lineEdit() const
{
    return QAbstractSpinBox::lineEdit();
}

void QDateEdit_QtDShell::__public_resetInputContext()
{
    QWidget::resetInputContext();
}

QObject*  QDateEdit_QtDShell::__public_sender() const
{
    return QObject::sender();
}

void QDateEdit_QtDShell::__public_setLineEdit(QLineEdit*  edit0)
{
    QAbstractSpinBox::setLineEdit((QLineEdit* )edit0);
}

void QDateEdit_QtDShell::__public_updateMicroFocus()
{
    QWidget::updateMicroFocus();
}

void QDateEdit_QtDShell::__public_customContextMenuRequested(const QPoint&  pos0)
{
    QWidget::customContextMenuRequested((const QPoint& )pos0);
}

void QDateEdit_QtDShell::__public_dateChanged(const QDate&  date0)
{
    QDateTimeEdit::dateChanged((const QDate& )date0);
}

void QDateEdit_QtDShell::__public_dateTimeChanged(const QDateTime&  date0)
{
    QDateTimeEdit::dateTimeChanged((const QDateTime& )date0);
}

void QDateEdit_QtDShell::__public_editingFinished()
{
    QAbstractSpinBox::editingFinished();
}

void QDateEdit_QtDShell::__public_timeChanged(const QTime&  date0)
{
    QDateTimeEdit::timeChanged((const QTime& )date0);
}

// Write virtual function overries used to decide on static/virtual calls
void QDateEdit_QtDShell::__override_actionEvent(QActionEvent*  arg__1, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_childEvent(QChildEvent*  arg__1, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_clear(bool static_call)
{
    if (static_call) {
        QDateTimeEdit::clear();
    } else {
...
void QDateEdit_QtDShell::__override_customEvent(QEvent*  arg__1, bool static_call)
{
    if (static_call) {
...
QDateTime  QDateEdit_QtDShell::__override_dateTimeFromText(const QString&  text0, bool static_call) const
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_dragEnterEvent(QDragEnterEvent*  arg__1, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_dragMoveEvent(QDragMoveEvent*  arg__1, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_dropEvent(QDropEvent*  arg__1, bool static_call)
{
    if (static_call) {
...
bool  QDateEdit_QtDShell::__override_event(QEvent*  event0, bool static_call)
{
    if (static_call) {
...
bool  QDateEdit_QtDShell::__override_eventFilter(QObject*  arg__1, QEvent*  arg__2, bool static_call)
{
    if (static_call) {
...
int  QDateEdit_QtDShell::__override_heightForWidth(int  arg__1, bool static_call) const
{
    if (static_call) {
...
QVariant  QDateEdit_QtDShell::__override_inputMethodQuery(int  arg__1, bool static_call) const
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_keyPressEvent(QKeyEvent*  event0, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_keyReleaseEvent(QKeyEvent*  event0, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_languageChange(bool static_call)
{
    if (static_call) {
...
int  QDateEdit_QtDShell::__override_metric(int  arg__1, bool static_call) const
{
    if (static_call) {
...
QSize  QDateEdit_QtDShell::__override_minimumSizeHint(bool static_call) const
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_mousePressEvent(QMouseEvent*  event0, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_mouseReleaseEvent(QMouseEvent*  event0, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_moveEvent(QMoveEvent*  arg__1, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_paintEvent(QPaintEvent*  event0, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_resizeEvent(QResizeEvent*  event0, bool static_call)
{
    if (static_call) {
...
void QDateEdit_QtDShell::__override_setVisible(bool  visible0, bool static_call)
{
    if (static_call) {
...
QSize  QDateEdit_QtDShell::__override_sizeHint(bool static_call) const
{
    if (static_call) {
...
QString  QDateEdit_QtDShell::__override_textFromDateTime(const QDateTime&  dt0, bool static_call) const
{
    if (static_call) {
...
int  QDateEdit_QtDShell::__override_validate(QString&  input0, int&  pos1, bool static_call) const
{
    if (static_call) {
...
// ---externC---
// QDateEdit::QDateEdit(QWidget * parent_)
QTD_EXTERN QTD_EXPORT void* qtd_QDateEdit_QDateEdit_QWidget
(void *d_ptr,
 void* parent0)
{
    QWidget*  __qt_parent0 = (QWidget* ) parent0;
    QDateEdit_QtDShell *__qt_this = new QDateEdit_QtDShell(d_ptr, (QWidget* )__qt_parent0);
    return (void *) __qt_this;

}

// QDateEdit::QDateEdit(const QDate & date, QWidget * parent_)
QTD_EXTERN QTD_EXPORT void* qtd_QDateEdit_QDateEdit_QDate_QWidget
(void *d_ptr,
 void* date0,
 void* parent1)
{
    ...
    QDateEdit_QtDShell *__qt_this = new QDateEdit_QtDShell(d_ptr, (const QDate& )__qt_date0, (QWidget* )__qt_parent1);
    return (void *) __qt_this;
...
QTD_EXTERN QTD_EXPORT void* qtd_QDateEdit_staticMetaObject() {
    return (void*)&QDateEdit::staticMetaObject;
}
