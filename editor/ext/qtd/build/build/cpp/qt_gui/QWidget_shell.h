#ifndef QWIDGET_SHELL_H
#define QWIDGET_SHELL_H
...
class QWidget_QtDShell : public QWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QWidget_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  f1);
    ~QWidget_QtDShell();
