#ifndef QSTATUSBAR_SHELL_H
#define QSTATUSBAR_SHELL_H
...
class QStatusBar_QtDShell : public QStatusBar, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QStatusBar_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QStatusBar_QtDShell();
    ...
    void __public_hideOrShow();
    void __public_reformat();
    ...
    void __public_messageChanged(const QString&  text0);
