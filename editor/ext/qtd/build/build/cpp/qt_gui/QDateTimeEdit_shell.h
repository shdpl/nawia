#ifndef QDATETIMEEDIT_SHELL_H
#define QDATETIMEEDIT_SHELL_H
...
class QDateTimeEdit_QtDShell : public QDateTimeEdit, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QDateTimeEdit_QtDShell(void *d_ptr, QWidget*  parent0);
    QDateTimeEdit_QtDShell(void *d_ptr, const QDate&  d0, QWidget*  parent1);
    QDateTimeEdit_QtDShell(void *d_ptr, const QDateTime&  dt0, QWidget*  parent1);
    QDateTimeEdit_QtDShell(void *d_ptr, const QTime&  t0, QWidget*  parent1);
    ~QDateTimeEdit_QtDShell();
    ...
    QDateTime  dateTimeFromText(const QString&  text0) const;
    int  devType() const;
    ...
    QString  textFromDateTime(const QDateTime&  dt0) const;
    ...
    void __public_dateChanged(const QDate&  date0);
    void __public_dateTimeChanged(const QDateTime&  date0);
    void __public_editingFinished();
    void __public_timeChanged(const QTime&  date0);
    ...
    QDateTime  __override_dateTimeFromText(const QString&  text0, bool static_call) const;
    ...
    QString  __override_textFromDateTime(const QDateTime&  dt0, bool static_call) const;
