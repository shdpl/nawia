#ifndef QGRAPHICSGRIDLAYOUT_SHELL_H
#define QGRAPHICSGRIDLAYOUT_SHELL_H
...
class QGraphicsGridLayout_QtDShell : public QGraphicsGridLayout, public QtdObjectLink
{
public:
    QGraphicsGridLayout_QtDShell(void *d_ptr, QGraphicsLayoutItem*  parent0);
    ~QGraphicsGridLayout_QtDShell();
    ...
    QGraphicsLayoutItem*  itemAt(int  row0, int  column1) const;
...
#endif // QGRAPHICSGRIDLAYOUT_SHELL_H
