#ifndef QABSTRACTBUTTON_SHELL_H
#define QABSTRACTBUTTON_SHELL_H
...
class QAbstractButton_QtDShell : public QAbstractButton, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QAbstractButton_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QAbstractButton_QtDShell();
