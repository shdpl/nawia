#ifndef QRADIOBUTTON_SHELL_H
#define QRADIOBUTTON_SHELL_H
...
class QRadioButton_QtDShell : public QRadioButton, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QRadioButton_QtDShell(void *d_ptr, QWidget*  parent0);
    QRadioButton_QtDShell(void *d_ptr, const QString&  text0, QWidget*  parent1);
    ~QRadioButton_QtDShell();
    ...
    void __public_initStyleOption(QStyleOptionButton*  button0) const;
    ...
    bool  __override_hitButton(const QPoint&  arg__1, bool static_call) const;
