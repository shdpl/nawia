#ifndef QTOOLBUTTON_SHELL_H
#define QTOOLBUTTON_SHELL_H
...
class QToolButton_QtDShell : public QToolButton, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QToolButton_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QToolButton_QtDShell();
    ...
    void __public_initStyleOption(QStyleOptionToolButton*  option0) const;
