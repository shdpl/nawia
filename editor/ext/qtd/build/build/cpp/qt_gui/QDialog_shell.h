#ifndef QDIALOG_SHELL_H
#define QDIALOG_SHELL_H
...
class QDialog_QtDShell : public QDialog, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QDialog_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  f1);
    ~QDialog_QtDShell();
