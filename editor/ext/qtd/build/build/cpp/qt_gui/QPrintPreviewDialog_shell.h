#ifndef QPRINTPREVIEWDIALOG_SHELL_H
#define QPRINTPREVIEWDIALOG_SHELL_H
...
class QPrintPreviewDialog_QtDShell : public QPrintPreviewDialog, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QPrintPreviewDialog_QtDShell(void *d_ptr, QPrinter*  printer0, QWidget*  parent1, Qt::WindowFlags  flags2);
    QPrintPreviewDialog_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  flags1);
    ~QPrintPreviewDialog_QtDShell();
...
#endif // QPRINTPREVIEWDIALOG_SHELL_H
