#ifndef QMENUBAR_SHELL_H
#define QMENUBAR_SHELL_H
...
class QMenuBar_QtDShell : public QMenuBar, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QMenuBar_QtDShell(void *d_ptr, QWidget*  parent0);
    ~QMenuBar_QtDShell();
