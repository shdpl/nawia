#ifndef QPRINTPREVIEWWIDGET_SHELL_H
#define QPRINTPREVIEWWIDGET_SHELL_H
...
class QPrintPreviewWidget_QtDShell : public QPrintPreviewWidget, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QPrintPreviewWidget_QtDShell(void *d_ptr, QPrinter*  printer0, QWidget*  parent1, Qt::WindowFlags  flags2);
    QPrintPreviewWidget_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  flags1);
    ~QPrintPreviewWidget_QtDShell();
    ...
    void __public_paintRequested(QPrinter*  printer0);
    void __public_previewChanged();
...
#endif // QPRINTPREVIEWWIDGET_SHELL_H
