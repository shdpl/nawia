#ifndef QFRAME_SHELL_H
#define QFRAME_SHELL_H
...
class QFrame_QtDShell : public QFrame, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QFrame_QtDShell(void *d_ptr, QWidget*  parent0, Qt::WindowFlags  f1);
    ~QFrame_QtDShell();
