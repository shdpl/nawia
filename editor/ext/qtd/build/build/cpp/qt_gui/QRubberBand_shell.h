#ifndef QRUBBERBAND_SHELL_H
#define QRUBBERBAND_SHELL_H
...
class QRubberBand_QtDShell : public QRubberBand, public QObjectLink
{
public:
  Q_OBJECT_CHECK
...
private:
public:
    QRubberBand_QtDShell(void *d_ptr, QRubberBand::Shape  arg__1, QWidget*  arg__2);
    ~QRubberBand_QtDShell();
    ...
    void __public_initStyleOption(QStyleOptionRubberBand*  option0) const;
