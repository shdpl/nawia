...
void main( void )
{
	...
	float sichtbar = max(0.0, dot(viewer, tsbNormal));
...
void main( void )
{
	...
	gl_FragColor.rgb =
		calcPhongSpotLight( newPos, normalize( normal ), albedo.rgb, specParams.x, specParams.y, -vsPos.z, 0.3 ) * 0.4;
}
...
void main( void )
{
	...
	gl_FragColor.rgb = albedo.rgb * 0.4;
