...
class SurfaceExtractorSimpleVolumeMaterial8 {
  private void* swigCPtr;
  protected bool swigCMemOwn;
  ...
  public static void* swigGetCPtr(SurfaceExtractorSimpleVolumeMaterial8 obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
  ...
  public void dispose() {
    synchronized(this) {
      if (swigCPtr !is null) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          PolyVoxCore_im.delete_SurfaceExtractorSimpleVolumeMaterial8(cast(void*)swigCPtr);
        }
        swigCPtr = null;
      }
    }
  ...
  public this(SimpleVolumeMaterial8 volData, Region region, SurfaceMeshPositionMaterialNormal result) {
    this(PolyVoxCore_im.new_SurfaceExtractorSimpleVolumeMaterial8(SimpleVolumeMaterial8.swigGetCPtr(volData), Region.swigGetCPtr(region), SurfaceMeshPositionMaterialNormal.swigGetCPtr(result)), true);
    if (PolyVoxCore_im.SwigPendingException.isPending) throw PolyVoxCore_im.SwigPendingException.retrieve();
  }

  public void execute() {
    PolyVoxCore_im.SurfaceExtractorSimpleVolumeMaterial8_execute(cast(void*)swigCPtr);
  }
}
