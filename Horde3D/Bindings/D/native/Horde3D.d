...
*/
bool h3dCheckExtension(  char *extensionName );
...
*/
 char *h3dGetMessage( int *level, float *time );
...
*/
float h3dGetOption( H3DOptions param );
...
*/
bool h3dSetOption( H3DOptions param, float value );
...
*/
float h3dGetStat( H3DStats param, bool reset );
...
/* Function: h3dGetResName
	...
	Details:
		...
		*Important Note: The pointer is  and allows only read access to the data. Do never try to modify the
...
*/
H3DRes h3dAddResource( int type,  char *name, int flags );
...
*/
H3DRes h3dCloneResource( H3DRes sourceRes,  char *name );
...
/* Function: h3dLoadResource
	...
	Returns:
		true in case of success, otherwise false
*/
bool h3dLoadResource( H3DRes res,  char *data, int size );
...
*/
int h3dFindResElem( H3DRes res, int elem, int param,  char *value );
...
/* Function: h3dGetResParamStr
	...
	Details:
		This function returns a specified property of the specified resource element.
		The property must be of the type string ( char *).
...
*/
 char *h3dGetResParamStr( H3DRes res, int elem, int elemIdx, int param );
...
/* Function: h3dSetResParamStr
	...
	Details:
		This function sets a specified property of the specified resource element to the
		specified value. The property must be of the type string ( char *).
	...
	Returns:
		nothing
*/
void h3dSetResParamStr( H3DRes res, int elem, int elemIdx, int param,  char *value );
...
*/
H3DRes h3dCreateTexture(  char *name, int width, int height, int fmt, int flags );
...
/* Function: h3dSetShaderPreambles
	...
	Returns:
		nothing
*/
void h3dSetShaderPreambles(  char *vertPreamble,  char *fragPreamble );
...
*/
bool h3dSetMaterialUniform( H3DRes materialRes,  char *name, float a, float b, float c, float d );
...
*/
bool h3dGetPipelineRenderTargetData( H3DRes pipelineRes,  char *targetName,
...
/* Function: h3dSetNodeTransMat
	...
	Returns:
		nothing
*/
void h3dSetNodeTransMat( H3DNode node,  float *mat4x4 );
...
/* Function: h3dGetNodeParamStr
	...
	Returns:
		value of the property or empty string if no such property exists
*/
 char *h3dGetNodeParamStr( H3DNode node, int param );
...
/* Function: h3dSetNodeParamStr
	...
	Returns:
		nothing
*/
void h3dSetNodeParamStr( H3DNode node, int param,  char *value );
...
*/
H3DNode h3dAddGroupNode( H3DNode parent,  char *name );
...
/* Function: h3dAddModelNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
H3DNode h3dAddModelNode( H3DNode parent,  char *name, H3DRes geometryRes );
...
*/
bool h3dSetModelMorpher( H3DNode modelNode,  char *target, float weight );
...
/* Function: h3dAddMeshNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
H3DNode h3dAddMeshNode( H3DNode parent,  char *name, H3DRes materialRes,
...
/* Function: h3dAddJointNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
H3DNode h3dAddJointNode( H3DNode parent,  char *name, int jointIndex );
...
/* Function: h3dAddLightNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
H3DNode h3dAddLightNode( H3DNode parent,  char *name, H3DRes materialRes,
                              char *lightingContext,  char *shadowContext );
...
/* Function: h3dAddCameraNode
	...
	Returns:
		handle to the created node or 0 in case of failure
*/
H3DNode h3dAddCameraNode( H3DNode parent,  char *name, H3DRes pipelineRes );
