...
*/
 char *h3dutGetResourcePath( int type );
...
/* Function: h3dutSetResourcePath
	...
	Returns:
		nothing
*/
void h3dutSetResourcePath( int type,  char *path );
...
*/
bool h3dutLoadResourcesFromDisk(  char *contentDir );
...
/* Function: h3dutCreateTGAImage
	...
	Parameters:
		pixels   - pointer to pixel source data in BGR(A) format from which TGA-image is ructed;
	...
	Returns:
		false if at least one resource could not be loaded, otherwise true
*/
bool h3dutCreateTGAImage(  ubyte *pixels, int width, int height, int bpp,
...
/* Function: h3dutShowText
	...
	Returns:
		nothing
*/
void h3dutShowText(  char *text, float x, float y, float size, float colR,
