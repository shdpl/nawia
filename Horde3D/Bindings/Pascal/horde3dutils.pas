...
procedure h3dutFreeMem(ptr: PPointer); cdecl; external Horde3DUtilsLib;
...
function h3dutInitOpenGL(hDC: Integer): Boolean; cdecl;
  external Horde3DUtilsLib;
...
function h3dutGetResourcePath(type_: H3DResTypes): PAnsiChar; cdecl;
  external Horde3DUtilsLib;
...
procedure h3dutSetResourcePath(type_: H3DResTypes; path: PAnsiChar); cdecl;
  external Horde3DUtilsLib;
...
function h3dutLoadResourcesFromDisk(contentDir: PAnsiChar): Boolean; cdecl;
  external Horde3DUtilsLib;
...
function h3dutCreateTGAImage(pixels: Pointer; width, height, bpp: Integer;
  outData: PPointer; outSize: PInteger): Boolean; cdecl;
  external Horde3DUtilsLib;
...
procedure h3dutPickRay(cameraNode: H3DNode; nwx, nwy: Single;
  ox, oy, oz, dx, dy, dz: PSingle); cdecl; external Horde3DUtilsLib;
...
function h3dutPickNode(cameraNode: H3DNode; nwx, nwy: Single): H3DNode; cdecl;
  external Horde3DUtilsLib;
...
procedure h3dutShowText(text: PAnsiChar; x, y, size, colR, colG, colB: Single;
  fontMaterialRes: H3DRes; layer: Integer); cdecl; external Horde3DUtilsLib;
...
procedure h3dutShowFrameStats(fontMaterialRes, panelMaterialRes: H3DRes;
  mode: Integer); cdecl; external Horde3DUtilsLib;
