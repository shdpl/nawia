...
import net.nawia.gsao.model.GuildWar;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Home object for domain model class GuildWar.
 * @see .GuildWar
 * @author Hibernate Tools
 */
@Stateless
public class GuildWarHome {

	private static final Logger log = LoggerFactory.getLogger(GuildWarHome.class);
