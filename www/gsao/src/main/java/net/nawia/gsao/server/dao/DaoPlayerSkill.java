...
import net.nawia.gsao.server.model.PlayerSkill;
import net.nawia.gsao.server.model.PlayerSkillId;
...
@Stateless
public class DaoPlayerSkill {

	private static final Logger log = LoggerFactory.getLogger(DaoPlayerSkill.class);
