...
import net.nawia.gsao.server.model.PlayerViplist;
import net.nawia.gsao.server.model.PlayerViplistId;
...
@Stateless
public class DaoPlayerViplist {

	private static final Logger log = LoggerFactory.getLogger(DaoPlayerViplist.class);
