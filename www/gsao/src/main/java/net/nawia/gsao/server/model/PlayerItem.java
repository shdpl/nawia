...
/**
 * Item carried by {@link Player}
 */
@Entity
@Table(name = "player_items", schema = "public", uniqueConstraints = @UniqueConstraint(columnNames = {
		"player_id", "sid" }))
public class PlayerItem implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4719862213129398797L;
	...
	public PlayerItem(PlayerItemId id, Player player) {
		this.id = id;
		this.player = player;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "attributes", column = @Column(name = "attributes")) })
