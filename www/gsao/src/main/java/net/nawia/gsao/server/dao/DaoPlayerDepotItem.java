...
import net.nawia.gsao.server.model.PlayerDepotItem;
import net.nawia.gsao.server.model.PlayerDepotItemId;
...
@Stateless
public class DaoPlayerDepotItem {

	private static final Logger log = LoggerFactory.getLogger(DaoPlayerDepotItem.class);
