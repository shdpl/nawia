...
/**
 * Id of {@link PlayerDepotItem}
 */
@Embeddable
public class PlayerDepotItemId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1912454386675205718L;
	...
	public PlayerDepotItemId() {
	}

	public PlayerDepotItemId(int playerId, int sid, int pid, int itemtype,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlayerDepotItemId))
			return false;
		PlayerDepotItemId castOther = (PlayerDepotItemId) other;
