...
/**
 * Skill, that is available to {@link Player}
 */
@Entity
@Table(name = "player_skills", schema = "public")
public class PlayerSkill implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2913777013986952080L;
	...
	public PlayerSkill(PlayerSkillId id, Player player) {
		this.id = id;
		this.player = player;
	}
