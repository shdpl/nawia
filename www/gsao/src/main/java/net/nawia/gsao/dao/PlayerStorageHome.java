...
import net.nawia.gsao.model.PlayerStorageId;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Home object for domain model class PlayerStorage.
 * @see net.nawia.gsao.model.PlayerStorage
 * @author Hibernate Tools
 */
@Stateless
public class PlayerStorageHome {

	private static final Logger log = LoggerFactory.getLogger(PlayerStorageHome.class);
