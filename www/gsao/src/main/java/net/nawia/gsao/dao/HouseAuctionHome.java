...
import net.nawia.gsao.model.HouseAuction;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Home object for domain model class HouseAuction.
 * @see .HouseAuction
 * @author Hibernate Tools
 */
@Stateless
public class HouseAuctionHome {

	private static final Logger log = LoggerFactory.getLogger(HouseAuctionHome.class);
