...
import net.nawia.gsao.server.model.HouseList;
import net.nawia.gsao.server.model.HouseListId;
...
@Stateless
public class DaoHouseList {

	private static final Logger log = LoggerFactory.getLogger(DaoHouseList.class);
