...
import net.nawia.gsao.model.GuildRank;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Home object for domain model class GuildRank.
 * @see .GuildRank
 * @author Hibernate Tools
 */
@Stateless
public class GuildRankHome {

	private static final Logger log = LoggerFactory.getLogger(GuildRankHome.class);
