...
import net.nawia.gsao.model.TileItem;
import net.nawia.gsao.model.TileItemId;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Home object for domain model class TileItem.
 * @see .TileItem
 * @author Hibernate Tools
 */
@Stateless
public class TileItemHome {

	private static final Logger log = LoggerFactory.getLogger(TileItemHome.class);
