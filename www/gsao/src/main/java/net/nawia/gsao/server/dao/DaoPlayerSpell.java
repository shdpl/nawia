...
import net.nawia.gsao.server.model.PlayerSpell;
import net.nawia.gsao.server.model.PlayerSpellId;
...
@Stateless
public class DaoPlayerSpell {

	private static final Logger log = LoggerFactory.getLogger(DaoPlayerSpell.class);
