...
import net.nawia.gsao.model.GlobalStorage;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Home object for domain model class GlobalStorage.
 * @see net.nawia.gsao.model.GlobalStorage
 * @author Hibernate Tools
 */
@Stateless
public class GlobalStorageHome {

	private static final Logger log = LoggerFactory.getLogger(GlobalStorageHome.class);
