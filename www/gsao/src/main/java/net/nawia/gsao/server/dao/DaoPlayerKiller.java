...
import net.nawia.gsao.server.model.PlayerKiller;
import net.nawia.gsao.server.model.PlayerKillerId;
...
@Stateless
public class DaoPlayerKiller {

	private static final Logger log = LoggerFactory.getLogger(DaoPlayerKiller.class);
