...
import net.nawia.gsao.model.EnvKiller;
import net.nawia.gsao.model.EnvKillerId;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Home object for domain model class EnvKiller.
 * @see .EnvKiller
 * @author Hibernate Tools
 */
@Stateless
public class EnvKillerHome {

	private static final Logger log = LoggerFactory.getLogger(EnvKillerHome.class);
